<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="AdvisorHeader.ascx.cs"
    Inherits="WealthERP.Advisor.AdvisorHeader" %>
        ...
        <td colspan="3" valign="top">
            <table width="100%" style="height: 30px">
                <tr style="height: auto">
                    ...
                    <td valign="bottom">
                        <asp:LinkButton ID="LinkButtonSignIn" runat="server">Sign Out</asp:LinkButton>
                    ...
                    <td>
                        <div id="menu_bar">
                            <ul id="nav" class="dropdown dropdown-horizontal">
                                <li id="n-home"><a href="./">Advisor Home</a></li>
