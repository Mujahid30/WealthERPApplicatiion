...
{
    public partial class CAMSTransInputRejects : System.Web.UI.UserControl
    {
        UserVo userVo;
        ...
        void BindRejectedRecordsGrid()
        {
            ...
            try
            {
                dsRejectedRecords = rejectedRecordsBo.GetTransInputRejects(processID, "CA", mypager.CurrentPage, out Count);
            }
            catch (Exception Ex)
            {
