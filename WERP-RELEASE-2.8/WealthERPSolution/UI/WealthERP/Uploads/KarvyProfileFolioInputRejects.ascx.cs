...
{
    public partial class KarvyProfileFolioInputRejects : System.Web.UI.UserControl
    {
        UserVo userVo;
        ...
        void BindRejectedRecordsGrid()
        {
            ...
            try
            {
                dsRejectedRecords = rejectedRecordsBo.GetProfileFolioInputRejects(processID, "KA", mypager.CurrentPage, out Count);
            }
            catch (Exception Ex)
            {
