...
<table style="width: 100%;" class="TableBackground">
    <tr>
     ...
     <tr>
        <td class="HeaderCell">
            <asp:Label ID="lblHeader" runat="server" CssClass="HeaderTextBig" Text="Templeton Profile Input Rejects"></asp:Label>
        </td>
    </tr>
    <tr>
        <td>
    ...
    <tr>
        <td>
            <asp:GridView ID="gvRejectedRecords" runat="server" AutoGenerateColumns="False" CellPadding="4"
                CssClass="GridViewStyle" ShowFooter="true" DataKeyNames="TempletonProfileInputId" >
