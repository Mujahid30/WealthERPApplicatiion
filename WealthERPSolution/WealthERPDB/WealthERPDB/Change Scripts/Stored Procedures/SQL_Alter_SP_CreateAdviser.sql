...
-- =============================================
ALTER PROCEDURE [dbo].[SP_CreateAdviser]
...
@A_FAX	numeric(8, 0),
@XABT_BusinessTypeCode	varchar(25),
...
@A_CreatedBy BIGINT,
@A_ModifiedBy BIGINT,
@A_AdviserLogo VARCHAR(25),
@AdviserId INT OUTPUT 
	
		
as

insert into dbo.Adviser (
	U_UserId,
	A_OrgName,
	A_AddressLine1,
	A_AddressLine2,
	...
	A_FAXSTD,
	A_FAX,
	XABT_BusinessTypeCode,
	A_ContactPersonFirstName,
	A_ContactPersonMiddleName,
	A_ContactPersonLastName,
	A_ContactPersonMobile,
	A_IsMultiBranch,
	A_CreatedBy,
	A_CreatedOn,
	A_ModifiedBy,
...
SELECT @AdviserId=SCOPE_IDENTITY()
--go
--exec createadvisor
