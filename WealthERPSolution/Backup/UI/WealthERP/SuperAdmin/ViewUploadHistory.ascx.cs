...
{
    public partial class ViewUploadHistory : System.Web.UI.UserControl
    {
        ...
        protected void ddlAction_OnSelectedIndexChange(object sender, EventArgs e)
        {
            ...
            {                
                ...
                adviserId = int.Parse(gvProcessLog.DataKeys[selectedRow].Values["A_AdviserId"].ToString());
                rmId = int.Parse(gvProcessLog.DataKeys[selectedRow].Values["AR_RMId"].ToString());
                ...
                else if (ddlAction.SelectedItem.Value.ToString() == Contants.ManageRejects)
                {
                    ...
                    {
                        Page.ClientScript.RegisterClientScriptBlock(this.GetType(), "leftpane", "loadcontrol('RejectedWERPProfileSA','?processId=" + processID + "&filetypeid=" + filetypeId + "');", true);
                    }
                       ...
                       && (extracttype == "FO"))
                    {
                        Page.ClientScript.RegisterClientScriptBlock(this.GetType(), "leftpane", "loadcontrol('RejectedMFFolioStagingSA','processId=" + processID + "&filetypeid=" + filetypeId + "');", true);
                    }
                       ...
                       && extracttype == "MFT")
                    {
                        Page.ClientScript.RegisterClientScriptBlock(this.GetType(), "leftpane", "loadcontrol('RejectedMFTransactionStagingSA','processId=" + processID + "&filetypeid=" + filetypeId + "');", true);
                    }


                    else if (filetypeId == (int)Contants.UploadTypes.EquityStandardTradeAccount && extracttype == "TAO")
                    {
                        Page.ClientScript.RegisterClientScriptBlock(this.GetType(), "leftpane", "loadcontrol('RejectedTradeAccountStagingSA','processId=" + processID + "&filetypeid=" + filetypeId + "');", true);
                    }
                            ...
                            if (extracttype == "PO" || extracttype == "PAF")
                            {
                                ...
                                if (karvyProCommonChecksResult)
                                {
                                    ...
                                    if (karvyProCreateCustomerResult)
                                    {
                                        ...
                                        bool karvyProCreateBankAccountResult = standardProfileUploadBo.StdCreationOfNewBankAccounts(processID, packagePath, configPath, adviserVo.advisorId);
                            ...
                            if (extracttype == "PO" || extracttype == "PAF")
                            {
                                ...
                                if (templetonProCommonChecksResult)
                                {
                                    ...
                                    if (templetonProCreateCustomerResult)
                                    {
                                        //Create new Bank Accounts
                                        packagePath = Server.MapPath("\\UploadPackages\\StandardProfileUploadPackageNew\\StandardProfileUploadPackageNew\\UploadCreateNewBankAccount.dtsx");
                                        bool templetonProCreateBankAccountResult = standardProfileUploadBo.StdCreationOfNewBankAccounts(processID, packagePath, configPath, adviserVo.advisorId);
                            ...
                            if (extracttype == "PO" || extracttype == "PAF")
                            {
                                ...
                                if (deutscheProCommonChecksResult)
                                {
                                    ...
                                    if (deutscheProCreateCustomerResult)
                                    {
                                        //Create new Bank Accounts
                                        packagePath = Server.MapPath("\\UploadPackages\\StandardProfileUploadPackageNew\\StandardProfileUploadPackageNew\\UploadCreateNewBankAccount.dtsx");
                                        bool deutscheProCreateBankAccountResult = standardProfileUploadBo.StdCreationOfNewBankAccounts(processID, packagePath, configPath, adviserVo.advisorId);
