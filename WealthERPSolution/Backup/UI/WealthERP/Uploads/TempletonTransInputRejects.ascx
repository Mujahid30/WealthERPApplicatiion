<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="TempletonTransInputRejects.ascx.cs"
    Inherits="WealthERP.Uploads.TempletonTransInputRejects" %>
                ...
                <table cellspacing="0" cellpadding="3" width="100%">
                    <tr>
                        <td align="left" style="width: 50%">
                            Templeton Transaction Input Rejects
                        </td>
...
<div runat="server" id="divGvRejectedRecords" visible="false" style="width:99%;overflow:scroll;">
    <telerik:RadGrid ID="gvRejectedRecords" runat="server" GridLines="None" AutoGenerateColumns="False"
        ...
        <mastertableview datakeynames="TempletonTransInputId" width="100%" allowmulticolumnsorting="True"
            ...
            <Columns>
                ...
                <telerik:GridBoundColumn DataField="COMP_CODE" HeaderText="COMP CODE" UniqueName="COMP_CODE"
                    SortExpression="COMP_CODE" AutoPostBackOnFilter="true" ShowFilterIcon="false">
                    <ItemStyle Width="" HorizontalAlign="left" Wrap="false" VerticalAlign="Top" />
                </telerik:GridBoundColumn>
