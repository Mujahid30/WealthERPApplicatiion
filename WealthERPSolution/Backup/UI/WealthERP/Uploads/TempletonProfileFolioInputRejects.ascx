<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="TempletonProfileFolioInputRejects.ascx.cs"
    Inherits="WealthERP.Uploads.TempletonProfileFolioInputRejects" %>
                ...
                <table cellspacing="0" cellpadding="3" width="100%">
                    <tr>
                        <td align="left"  style="width: 50%">
                            Templeton Profile Input Rejects
                        </td>
...
<div runat="server" id="divGvRejectedRecords" visible="false"  style="width:99%;overflow:scroll;">
    <telerik:RadGrid ID="gvRejectedRecords" runat="server" GridLines="None" AutoGenerateColumns="False"
        ...
        <mastertableview datakeynames="TempletonProfileInputId" width="100%" allowmulticolumnsorting="True"
            ...
            <Columns>
                ...
                <telerik:GridBoundColumn DataField="DATE_OF_BIRTH" HeaderText="DOB" UniqueName="DATE_OF_BIRTH" SortExpression="DATE_OF_BIRTH"
                 ...
                 <telerik:GridBoundColumn DataField="B_PIN_CODE" HeaderText="BANK PIN CODE" UniqueName="B_PIN_CODE" SortExpression="B_PIN_CODE"
                    AutoPostBackOnFilter="true" ShowFilterIcon="false">
                    <ItemStyle Width="" HorizontalAlign="left" Wrap="false" VerticalAlign="Top" />
                </telerik:GridBoundColumn>
            </Columns>
