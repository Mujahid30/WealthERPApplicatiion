<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MFSTPDetails.aspx.cs" Inherits="WealthERP.CustomerPortfolio.MFSTPDetails" %>
        ...
        <table style="width:50%;" align="center">
            <tr>
                <td colspan="2" align="center">
                    <asp:Label ID="Label1" runat="server" Text="STP Details" 
            ...
            <tr>
                <td align="left" class="style2">
                    <asp:Label ID="Label9" runat="server" CssClass="FieldName" Text="To Scheme"></asp:Label>
                </td>
                <td>
                    <asp:TextBox ID="txtToScheme" runat="server" CssClass="txtField"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td align="left" class="style2">
