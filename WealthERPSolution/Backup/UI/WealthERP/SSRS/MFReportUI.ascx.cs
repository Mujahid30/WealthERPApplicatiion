...
{
    public partial class MFReportUI : System.Web.UI.UserControl
    {
        RMVo rmVo = new RMVo();
        ...
        private void AddCustomReports()
        {
            if (advisorVo.advisorId == 4261)
            {
                ddlReportSubType.Items.Add(new ListItem("MF Holding With Bank Detail", "PORTFOLIO_RETURNS_WITHBANKDETAILS"));
            }
        }
