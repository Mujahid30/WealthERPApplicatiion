<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="AdvisorCategoryConfiguration.ascx.cs" Inherits="WealthERP.AdvsierPreferenceSettings.AdvisorCategoryConfiguration" %>
