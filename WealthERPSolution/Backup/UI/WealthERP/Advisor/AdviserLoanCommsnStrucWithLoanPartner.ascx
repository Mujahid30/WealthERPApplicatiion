<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="AdviserLoanCommsnStrucWithLoanPartner.ascx.cs"
    Inherits="WealthERP.Advisor.AdviserLoanCommsnStrucWithLoanPartner" %>
...
<table width="100%" cellspacing="0" cellpadding="0">
    <tr>
        <td>
            <asp:Panel ID="Panel1" runat="server" Width="100%" ScrollBars="Horizontal" HorizontalAlign="Left">
             <div id="dvHoldings" runat="server" style="width: 650px; padding:4px">
                <asp:GridView ID="gvLnCommsnStrucLnPtr" runat="server" AutoGenerateColumns="False"
                    Width="100%" CellPadding="4" ShowFooter="True" CssClass="GridViewStyle" AllowPaging="True"
                    DataKeyNames="ALPC_Id" OnRowDataBound="gvLnCommsnStrucLnPtr_RowDataBound" OnRowDeleting="gvRowDeleting"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Commission Fee">
                            <ItemTemplate>
                                <asp:TextBox ID="txtCommissionFee" runat="server" Text='<%# Bind("CommissionFee") %>'
                                    CssClass="txtField" />
                            </ItemTemplate>
                            <FooterTemplate>
                        ...
                        <asp:TemplateField HeaderText="Lower limit of range">
                            <ItemTemplate>
                                <asp:TextBox ID="txtSlabLowerLimit" runat="server" Text='<%# Bind("SlabLowerLimit") %>'
                                    CssClass="txtField" />
                            </ItemTemplate>
                            <FooterTemplate>
                        ...
                        <asp:TemplateField HeaderText="Upper limit of range">
                            <ItemTemplate>
                                <asp:TextBox ID="txtSlabUpperLimit" runat="server" Text='<%# Bind("SlabUpperLimit") %>'
                                    CssClass="txtField" />
                                <asp:CompareValidator ID="CompareValidator13" runat="server" ControlToValidate="txtSlabUpperLimit"
                                    ...
                                    Operator="GreaterThan" ControlToCompare="txtSlabLowerLimit" CssClass="cvPCG"
                            ...
                            <FooterTemplate>
                                ...
                                <asp:CompareValidator ID="CompareValidator13" runat="server" ControlToValidate="txtAddSlabUpperLimit"
                                    ErrorMessage="Lower Limit should be less than the Upper Limit" Type="Double"
                                    Operator="GreaterThan" ControlToCompare="txtAddSlabLowerLimit" CssClass="cvPCG"
                                    ValidationGroup="btnSubmit" Display="Dynamic"></asp:CompareValidator>
                            </FooterTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Start Date">
                            <ItemTemplate>
                                <asp:TextBox ID="txtStartDate" runat="server" Text='<%#  Eval("StartDate", "{0:dd-MM-yyyy}") %>'
                                    CssClass="txtField" />
                            ...
                            <FooterTemplate>
                                ...
                                <cc1:CalendarExtender ID="txtAddStartDate_CalendarExtender" runat="server" TargetControlID="txtAddStartDate"
                                    Format="dd/MM/yyyy">
                                </cc1:CalendarExtender>
                        ...
                        <asp:TemplateField HeaderText="End Date">
                            <ItemTemplate>
                                <asp:TextBox ID="txtEndDate" runat="server" Text='<%# Eval("EndDate", "{0:dd-MM-yyyy}") %>'
                                    CssClass="txtField" />
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            ...
                            <FooterTemplate>
                                ...
                                <cc1:CalendarExtender ID="txtAddEndDate_CalendarExtender" runat="server" TargetControlID="txtAddEndDate"
                                    Format="dd/MM/yyyy">
                                </cc1:CalendarExtender>
...
<table width="100%">
    <tr id="trValueInserted" runat="server" visible="false">
        <td>
            <asp:Label ID="lblValueInserted" Text="New Values Inserted Successfully" runat="server"
                CssClass="FieldName"></asp:Label>
        </td>
    </tr>
    <tr id="trValuesUpdated" runat="server" visible="false">
        <td>
            <asp:Label ID="lblValuesUpdated" Text="Changes Updated Successfully" runat="server"
                CssClass="FieldName"></asp:Label>
        </td>
    </tr>
    <tr id="trInsertError" runat="server" visible="false">
        <td>
            <asp:Label ID="lblInsertError" Text="There was an error during insertion." runat="server"
                CssClass="Error"></asp:Label>
        </td>
    </tr>
    <tr id="trUpdateError" runat="server" visible="false">
        <td>
            <asp:Label ID="Label1" Text="There was an error during updation of one of the rows."
                runat="server" CssClass="Error"></asp:Label>
        </td>
    </tr>
    <tr>
        <td>
