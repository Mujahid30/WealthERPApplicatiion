                ...
                <table cellspacing="0" width="100%">
                    <tr>
                        ...
                        <td align="right" style="padding-bottom: 2px;">
                            <asp:ImageButton ID="imageExcel" ImageUrl="~/App_Themes/Maroon/Images/Export_Excel.png"
                                runat="server" AlternateText="Excel" ToolTip="Export to Excel" OnClientClick="setFormat('excel')"
                                Height="25px" Width="25px" OnClick="imageExcel_Click" />
...
<table class="TableBackground" width="100%" id="tblGv" runat="server">
    <tr id="Tr1" runat="server">
        <td>
            ...
            <asp:Button CssClass="ExportButton" ID="btnExportExcel" Style="display: none" runat="server"
                Height="31px" Width="35px" OnClick="btnExportExcel_Click2" />
        </td>
    </tr>
</table>
    ...
    <table style="vertical-align: top;">
        <tr>
            <td style="vertical-align: top;">
                ...
                <asp:DropDownList ID="ddlBMBranchList" CssClass="cmbField" runat="server" OnSelectedIndexChanged="ddlBMBranchList_SelectedIndexChanged"
                    AutoPostBack="true">
                </asp:DropDownList>
            </td>
        </tr>
    </table>
    <table id="ErrorMessage" width="100%" cellspacing="0" cellpadding="0" align="center"
        runat="server">
        <tr>
            ...
            <tr>
                <td class="rightField">
                    <asp:GridView ID="gvCustomers" runat="server" AutoGenerateColumns="False" CellPadding="4"
                        ...
                        AllowSorting="True" HorizontalAlign="Center" OnSorting="gvCustomers_Sort" GridLines="Both"
                        Width="1480px">
                        ...
                        <Columns>
                            <asp:TemplateField ItemStyle-Width="25px">
                                <ItemTemplate>
                                    <asp:DropDownList ID="ddlAction" runat="server" AutoPostBack="true" Width="80px"
                                        CssClass="GridViewCmbField" OnSelectedIndexChanged="ddlAction_OnSelectedIndexChange">
                            ...
                            <asp:TemplateField ItemStyle-Wrap="false" ItemStyle-Width="18px">
                                <HeaderTemplate>
                                    ...
                                    <br />
                                    <asp:DropDownList ID="ddlParent" AutoPostBack="true" CssClass="GridViewCmbField"
                                        runat="server" Width="170px" OnSelectedIndexChanged="ddlParent_SelectedIndexChanged">
                                    </asp:DropDownList>
                                </HeaderTemplate>
                                <ItemTemplate>
                            ...
                            <asp:TemplateField ItemStyle-Wrap="false">
                                <HeaderTemplate>
                                    ...
                                    <br />
                                    <asp:TextBox ID="txtPAN" runat="server" CssClass="GridViewTxtField" onkeydown="return JSdoPostback(event,'ctrl_BMCustomer_btnPANSearch');" />
                                </HeaderTemplate>
                                <ItemTemplate>
                            ...
                            <asp:TemplateField ItemStyle-Wrap="false" ItemStyle-Width="80px">
                                <HeaderTemplate>
                                    ...
                                    <br />
                                    <asp:TextBox ID="txtAreaSearch" runat="server" Width="120px" CssClass="GridViewTxtField"
                                        onkeydown="return JSdoPostback(event,'ctrl_BMCustomer_btnAreaSearch');" />
                                </HeaderTemplate>
                                <ItemTemplate>
                            ...
                            <asp:TemplateField ItemStyle-Wrap="false" ItemStyle-Width="170px">
                                <HeaderTemplate>
                                    ...
                                    <br />
                                    <asp:DropDownList ID="ddlCity" AutoPostBack="true" CssClass="GridViewCmbField" Width="100px"
                            ...
                            <asp:TemplateField HeaderStyle-Wrap="false" ItemStyle-Wrap="false">
                                ...
                                <ItemTemplate>
                                    <asp:Label ID="lblAssignedRMHeader" runat="server" Text='<%# Eval("RMAssigned").ToString() %>'></asp:Label>
                                </ItemTemplate>
                                <ItemStyle Wrap="False" />
                            </asp:TemplateField>
                            <asp:TemplateField HeaderStyle-Wrap="false" HeaderText="Is Prospect" ItemStyle-Wrap="false">
                                <HeaderTemplate>
                                    <asp:Label ID="lblHeaderddlIsProspect" runat="server" Text="Is Prospect"></asp:Label>
                                    <br />
                                    <asp:DropDownList ID="ddlIsProspect" runat="server" OnPreRender="SetValue" OnSelectedIndexChanged="ddlIsProspect_SelectedIndexChanged"
                                        AutoPostBack="true" CssClass="GridViewCmbField">
                            ...
                            <asp:TemplateField HeaderStyle-Wrap="false" ItemStyle-Wrap="false">
                                ...
                                <ItemTemplate>
                                    <asp:Label ID="lblProcessId" runat="server" Text='<%# Eval("ADUL_ProcessId").ToString() %>'>
                                    </asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                        </Columns>
