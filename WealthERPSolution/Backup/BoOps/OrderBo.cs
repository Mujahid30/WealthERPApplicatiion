...
namespace BoOps
{
    public class OrderBo
    {
        ...
        { 
            ...
            try
            {
                dtOrder = orderDao.GetOrderList(systematicId, advisorId, rmId, branchId, toDate, fromDate, status, customerId, orderType, usertype, AgentId, SubBrokerCode, AgentCode, orderId, transactionType, folioNo,userId);
            }
            catch (BaseApplicationException Ex)
            {
                throw Ex;
