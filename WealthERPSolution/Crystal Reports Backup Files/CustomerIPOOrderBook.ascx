...
<asp:UpdatePanel ID="updIPOOrderBook" runat="server">
    <ContentTemplate>
        <table width="100%">
            <tr>
                <td>
                            ...
                            <tr>
                                ...
                                <td align="right">
                                    <asp:ImageButton ID="ibtExportSummary" ImageUrl="~/App_Themes/Maroon/Images/Export_Excel.png"
                                        ...
                                        TabIndex="9" Height="25px" Width="25px" Visible="false" CausesValidation="false">
                                    </asp:ImageButton>
                                </td>
                            </tr>
                        </table>
                                ...
                                <Columns>
                                            ...
                                            <div class="col-sm-12 col-sm-12 col-md-12 col-lg-12 divs">
                                                ...
                                                <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3 fk-font-3" style="margin-bottom: 1.5px;">
                                                    ...
                                                    <asp:LinkButton ID="lnkModify" runat="server" OnClick="btnEditModiY_Click" class="glyphicon glyphicon-edit"
                                                        ToolTip="Modify" />
                                                    <asp:LinkButton ID="lnkCancel" runat="server" Enabled="false" Style="font-style: underline"
                                                        OnClick="btnEditModiY_Click" class="glyphicon glyphicon-remove-circle" ToolTip="Cancel"
                                                        OnClientClick="GetBalanceQty('Cancel');" />
                                                </div>
                                                <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3 fk-font-3" style="margin-bottom: 1.5px;">
                                    ...
                                    <telerik:GridTemplateColumn AllowFiltering="false">
                                        <ItemTemplate>
                                            <tr>
                                                <td colspan="100%">
                                                    <asp:Panel ID="pnlchild" runat="server" Style="display: inline" Width="100%" ScrollBars="Both"
                                                        Visible="false">
