<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ProductgroupSetup.ascx.cs" Inherits="WealthERP.Advisor.ProductgroupSetup" %>
...
<tr>
<td>
 <telerik:RadGrid ID="gvHirarchy"  runat="server" CssClass="RadGrid"
        ...
        AllowAutomaticInserts="false" OnNeedDataSource="gvHirarchy_NeedDataSource"
        AllowAutomaticUpdates="false" Skin="Telerik" OnItemDataBound="gvHirarchy_ItemDataBound"
        EnableEmbeddedSkins="false" OnItemCommand="gvHirarchy_ItemCommand"
        ...
        <MasterTableView DataKeyNames="AH_Id,AH_HierarchyName,AH_TitleId,AH_Teamname,AH_TeamId,AH_ReportsToId,AH_ReportsTo,AH_ChannelName,AH_ChannelId,AH_Sequence"
            ...
            <Columns>
               <%-- <telerik:GridEditCommandColumn EditText="Edit" UniqueName="editColumn" CancelText="Cancel"
                ...
                <telerik:GridBoundColumn   UniqueName="AH_HierarchyName" HeaderText="Role/Title"
                    DataField="AH_HierarchyName" SortExpression="AH_HierarchyName" AllowFiltering="true"
                    ShowFilterIcon="false" AutoPostBackOnFilter="true">
                    <HeaderStyle></HeaderStyle>
                </telerik:GridBoundColumn>
                ...
                <telerik:GridBoundColumn UniqueName="AH_TeamId" Visible="false"  HeaderText="Teamid" DataField="AH_TeamId"
                    SortExpression="AH_TeamId" AllowFiltering="true" ShowFilterIcon="false" AutoPostBackOnFilter="true">
                    <HeaderStyle></HeaderStyle>
                </telerik:GridBoundColumn>
                <telerik:GridBoundColumn Visible="false" UniqueName="AH_ReportsToId" HeaderText="ReportsToId" DataField="AH_ReportsToId" SortExpression="Name"
                    AllowFiltering="true" ShowFilterIcon="false" AutoPostBackOnFilter="true">
                    <HeaderStyle></HeaderStyle>
                </telerik:GridBoundColumn>
                <telerik:GridBoundColumn HeaderStyle-Width="200px" UniqueName="AH_ReportsTo"
                    HeaderText="ReportingTo" DataField="AH_ReportsTo" SortExpression="AH_ReportsTo"
                    AllowFiltering="true" ShowFilterIcon="false" AutoPostBackOnFilter="true">
                    <HeaderStyle></HeaderStyle>
                </telerik:GridBoundColumn>
                <telerik:GridBoundColumn UniqueName="AH_ChannelName" HeaderText="Channel" DataField="AH_ChannelName"
                    SortExpression="AH_ChannelName" AllowFiltering="true" ShowFilterIcon="false" AutoPostBackOnFilter="true">
                    <HeaderStyle></HeaderStyle>
                </telerik:GridBoundColumn>
                            ...
                            <td>
                                <table id="Table3" cellspacing="1" cellpadding="1" border="0" width="390px">
                                    ...
                                    <tr>
                                        ...
                                        <td  colspan="3">
                                            <telerik:RadComboBox   AutoPostBack="true" 
                                                runat="server" ID="rcbSetup" EmptyMessage="Select" OnSelectedIndexChanged="rcbSetup_SelectedIndexChanged">
                                                 <Items>
                                   ...
                                   <tr> 
                                        ...
                                        <td  colspan="3">
                                            <telerik:RadComboBox  AutoPostBack="true" 
                                                runat="server" ID="rcbTeamm" EmptyMessage="Select"  >
                                   ...
                                   <tr>
                                        ...
                                        <td colspan="3">
                                            <telerik:RadComboBox   AutoPostBack="true" runat="server" ID="rcbChanel" EmptyMessage="Select" OnSelectedIndexChanged="rcbChanel_SelectedIndexChanged">                                          
                                            </telerik:RadComboBox>
