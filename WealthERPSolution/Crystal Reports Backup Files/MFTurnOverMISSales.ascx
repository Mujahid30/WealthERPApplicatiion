...
<asp:UpdatePanel runat="server" ID="UpdatePanel1" EnableViewState="true">
                    ...
                    <asp:Panel ID="pnlOrganization" ScrollBars="Horizontal" runat="server">
                        <div runat="server" id="divOrganization" style="margin: 2px; width: 640px;">
                            <telerik:RadGrid ID="gvOrganization" runat="server" GridLines="None" AutoGenerateColumns="false"
                                ...
                                OnItemDataBound="gvOrganization_OnItemDataBound">
                                <ExportSettings HideStructureColumns="true" ExportOnlyData="true" IgnorePaging="true"
    ...
    <Triggers>
        <asp:PostBackTrigger ControlID="lnkBtnOrganization" />
        <asp:PostBackTrigger ControlID="lnkBtnSubBrokerCustomer" />
        <asp:PostBackTrigger ControlID="lnkBtnProduct" />
    </Triggers>
</asp:UpdatePanel>
