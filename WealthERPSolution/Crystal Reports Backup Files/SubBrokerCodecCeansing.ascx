...
<%--<asp:UpdatePanel ID="updSubbrokerCode" runat="server">
    <ContentTemplate>--%>
<table>
    <tr>
        <td align="right">
    ...
    <tr>
        ...
        <td>
            <asp:DropDownList ID="ddlSubbrokerCode" runat="server" CssClass="cmbField" Width="340px">
                ...
                <asp:ListItem Text="Exist & Registered" Value="1"></asp:ListItem>
                <asp:ListItem Text="Exist & Non Registered" Value="2"></asp:ListItem>
                <asp:ListItem Text="Not Exist" Value="3"></asp:ListItem>
            </asp:DropDownList>
...
<table>
    <tr>
        <td>
            <asp:Button ID="btnUpdateSubBroker" runat="server" CssClass="PCGButton" Text="Update"
                OnClick="btnUpdateSubBroker_OnClick" Visible="false" />
        </td>
    </tr>
</table>
<%--  </ContentTemplate>
