                    ...
                    <div id="GeneralHeader" style="height: auto" visible="true" runat="server">
                        <table width="100%">
                            ...
                            <tr style="height: 35px; border: border 2 #0000FF">
                                <td class="PCGRedBcknde" style="width: 18%;">
                                ...
                                <td colspan="2" class="PCGRedBcknde" valign="middle">
...
--%>
                                <asp:Label ID="PCGLabel" Text="© 2014. All rights Reserved. SBICAP Securities Limited." runat="server" 
