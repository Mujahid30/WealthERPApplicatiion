...
<br />
<telerik:RadGrid ID="gvrSystematicSchemes" Visible="false" runat="server" CssClass="RadGrid" 
    GridLines="None" Width="100%" AllowPaging="True" PageSize="15" AllowSorting="true"
    AutoGenerateColumns="false" ShowStatusBar="true" AllowAutomaticDeletes="True"
    AllowAutomaticInserts="false" ShowFooter="true" AllowAutomaticUpdates="false"
    Skin="Telerik" OnNeedDataSource="gvMFFolio_NeedDataSource" EnableEmbeddedSkins="false"
    ...
    <MasterTableView DataKeyNames="SystematicSetupId">
        <Columns>
            ...
            <telerik:GridBoundColumn HeaderText="Systematic Transaction Type" HeaderStyle-Width="100px"
