...
//************************************************************************************************************************
       ...
       //---------------------------SIP Uploads-------------------------------------\\
        ...
        //--------------------------start SIP Templeton Uploads----------------------------\\
        public bool SundaramSIPInsertToInputTrans(int processId, string Packagepath, string XMLFilepath, string configPath)
        {
            bool IsProcessComplete = false;
            ...
            catch (Exception Ex)
            {
                ...
                FunctionInfo.Add("Method", "CamsUploadsBo.cs:SundaramSIPInsertToInputTrans()");
        ...
        public bool SundaramSIPInsertToStagingTrans(int adviserId, int processId, string Packagepath, string configPath)
        {
            bool IsProcessComplete = false;
            try
            {
            ...
            catch (Exception Ex)
            {
                ...
                FunctionInfo.Add("Method", "CamsUploadsBo.cs:SundaramSIPInsertToStagingTrans()");
        ...
        public bool SundaramSIPProcessDataInStagingTrans(int adviserId, int processId, string Packagepath, string configPath)
        {
            bool IsProcessComplete = false;
            try
            {
            ...
            catch (Exception Ex)
            {
                ...
                FunctionInfo.Add("Method", "CamsUploadsBo.cs:SundaramSIPProcessDataInStagingTrans()");
        ...
        public bool SundaramSIPStagingToCommonStaging(int processId, string Packagepath, string configPath)
        {
            bool IsProcessComplete = false;
            try
            {
            ...
            catch (Exception Ex)
            {
                ...
                FunctionInfo.Add("Method", "CamsUploadsBo.cs:SundaramSIPStagingToCommonStaging()");
        ...
        public bool SundaramSIPCommonStagingChk(int processId, string Packagepath, string configPath, string UploadTypeShortForm)
        {
            bool IsProcessComplete = false;
            try
            {
            ...
            catch (Exception Ex)
            {
                ...
                FunctionInfo.Add("Method", "CamsUploadsBo.cs:SundaramSIPCommonStagingChk()");
        ...
        public bool SundaramSIPCommonStagingToWERP(int processId, string Packagepath, string configPath)
        {
            bool IsProcessComplete = false;
            try
            {
            ...
            catch (Exception Ex)
            {
                ...
                FunctionInfo.Add("Method", "CamsUploadsBo.cs:SundaramSIPCommonStagingToWERP()");
        ...
        //--------------------------END SIP Sundaram Uploads-------------------------------\\

        //--------------------------start SIP Templeton Uploads----------------------------\\
        public bool TempletonSIPInsertToInputTrans(int processId, string Packagepath, string XMLFilepath, string configPath)
        {
            bool IsProcessComplete = false;
        ...
        public bool TempletonSIPInsertToStagingTrans(int adviserId, int processId, string Packagepath, string configPath)
        {
            bool IsProcessComplete = false;
            try
            {
        ...
        public bool TempletonSIPProcessDataInStagingTrans(int adviserId, int processId, string Packagepath, string configPath)
        {
            bool IsProcessComplete = false;
            try
            {
        ...
        public bool TempletonSIPStagingToCommonStaging(int processId, string Packagepath, string configPath)
        {
            bool IsProcessComplete = false;
            try
            {
        ...
        public bool TempletonSIPCommonStagingChk(int processId, string Packagepath, string configPath, string UploadTypeShortForm)
        {
            bool IsProcessComplete = false;
            try
            {
        ...
        public bool TempletonSIPCommonStagingToWERP(int processId, string Packagepath, string configPath)
        {
            bool IsProcessComplete = false;
            try
            {
        ...
        public bool KARVYTrailCommissionInsertToInputTrans(int processId, string Packagepath, string XMLFilepath, string configPath)
        {
            bool IsProcessComplete = false;
        ...
        public bool KARVYTrailCommissionInsertToStagingTrans(int processId, string Packagepath, string configPath)
        {
            bool IsProcessComplete = false;
            try
            {
        ...
        public bool KARVYTrailCommissionStagingToCommonStaging(int processId, string Packagepath, string configPath)
        {
            bool IsProcessComplete = false;
            try
            {
        ...
        public bool KARVYTrailCommissionCommonStagingToWERP(int processId, string Packagepath, string configPath)
        {
            bool IsProcessComplete = false;
            try
            {
        ...
        //-------------------------End KARVY Trail Commission Uploads---------------------------------\\

        //--------------------------Deutsche Trail Commission Uploads---------------------------------\\
        public bool DeutscheTrailCommissionInsertToInputTrans(int processId, string Packagepath, string XMLFilepath, string configPath)
        {
            bool IsProcessComplete = false;
        ...
        public bool DeutscheTrailCommissionInsertToStagingTrans(int processId, string Packagepath, string configPath)
        {
            bool IsProcessComplete = false;
            try
            {
        ...
        public bool DeutscheTrailCommissionProcessDataInStagingTrans(int adviserId, int processId, string Packagepath, string configPath)
        {
            bool IsProcessComplete = false;
            try
            {
        ...
        public bool DeutscheTrailCommissionStagingToCommonStaging(int processId, string Packagepath, string configPath)
        {
            bool IsProcessComplete = false;
            try
            {
        ...
        public bool DeutscheTrailCommissionCommonStagingChk(int processId, string Packagepath, string configPath, string UploadTypeShortForm)
        {
            bool IsProcessComplete = false;
            try
            {
        ...
        public bool DeutscheTrailCommissionCommonStagingToWERP(int processId, string Packagepath, string configPath)
        {
            bool IsProcessComplete = false;
            try
            {
