...
namespace BoFPSuperlite
{
    ...
    {  
        ...
        public void UpdateFutureSavingProjection(int customerId, int advisorId, decimal equityFutureAllocation, decimal debtFutureAllocation, decimal cashFutureAllocation, decimal alternateFutureAllocation, int tempYear,int RangeFromYear,int RangeToYear)
     {
        ...
        public int CreateCashFlowRecomendation(int CustomerId, int userId, int CRPL_ID, int CCRLSourceId, String CCRL_BuyType, decimal CCRLAmount, DateTime startDate, DateTime endDate, decimal SumAssured, DateTime CCRL_RecommendationDate, string Remarks, String CCRL_FrequencyMode, int CCRL_Paymentmode, int CCRL_tenure)
        {
            CustomerFPAnalyticsDao customerFPAnalyticsDao = new CustomerFPAnalyticsDao();
            int customercashrecomendationid;
            try
            {
                customercashrecomendationid = customerFPAnalyticsDao.CreateCashFlowRecomendation(CustomerId, userId, CRPL_ID, CCRLSourceId, CCRL_BuyType, CCRLAmount, startDate, endDate, SumAssured, CCRL_RecommendationDate, Remarks, CCRL_FrequencyMode, CCRL_Paymentmode, CCRL_tenure);
        ...
        public int UpdateCashFlowRecomendation(int CustomerId, int userId, int CCRL_ID, int CRPL_ID, int CCRLSourceId, String CCRL_BuyType, decimal CCRLAmount, DateTime startDate, DateTime endDate, decimal SumAssured, DateTime CCRL_RecommendationDate, string Remarks, String CCRL_FrequencyMode, int CCRL_Paymentmode, int CCRL_tenure)
        {
            CustomerFPAnalyticsDao customerFPAnalyticsDao = new CustomerFPAnalyticsDao();
            int customercashrecomendationid;
            try
            {
                customercashrecomendationid = customerFPAnalyticsDao.UpdateCashFlowRecomendation(CCRL_ID,CustomerId, userId, CRPL_ID, CCRLSourceId, CCRL_BuyType, CCRLAmount, startDate, endDate, SumAssured,CCRL_RecommendationDate, Remarks, CCRL_FrequencyMode,CCRL_Paymentmode,CCRL_tenure);
