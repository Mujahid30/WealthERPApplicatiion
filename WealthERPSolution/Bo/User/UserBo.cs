...
namespace BoUser
{
    public class UserBo
    {
      ...
      //  public bool updateUser(AdvisorVo advisorVo)
        ...
        public DataTable getselectcity(string state_id)
        {
            DataTable dt = new DataTable();
            //UserVo userVo = null;
            UserDao userDao = new UserDao();
            ...
            {
                //  userVo = userDao.Getselectlist();
                dt = userDao.getselectcitylist(state_id);
        ...
        public void  Createrinfo(UserVo userVo)
        {
            int userId;
            UserDao userDao = new UserDao();
            try
            {
                userId = userDao.Getselectname(userVo);
            }
            catch (BaseApplicationException Ex)
            {
                throw Ex;
