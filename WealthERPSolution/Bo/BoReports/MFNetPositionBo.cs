...
namespace BoReports
{
    ...
    public class MFNetPositionBo
    {
        MFNetPositionDao MFNetPositionDao = new MFNetPositionDao();
        //----------Pairing Starts
        ...
        {
            DataTable dtTranxn = MFNetPositionDao.GetCustomerMFTransactions(C_CustomerId, PortfolioIds, FromDate, ToDate).Tables[0];
            ...
            dtMFReturnsHolding.Columns.Add("HoldStartDate");
            dtMFReturnsHolding.Columns.Add("BalanceUnits", typeof(decimal));
            dtMFReturnsHolding.Columns.Add("PurUnits", typeof(decimal));
            dtMFReturnsHolding.Columns.Add("TotalUnits", typeof(decimal));
            ...
            dtMFReturnsHolding.Columns.Add("DVRUnits", typeof(decimal));
            ...
            dtMFReturnsHolding.Columns.Add("SubCategory");
            ...
            if (dtTranxn.Rows.Count > 0)
            {
                ...
                DataTable dtSchemeList = new DataView(dtBuy).ToTable(true, new[] { "CustomerName", "CustomerId", "PortfolioName", "PortfolioId", "FolioNum", "ScripCode", "ScripName", "MktPrice", "MktPriceDate", "Category", "SubCategory" });
                ...
                foreach (DataRow dr in dtSchemeList.Rows)
                {
                    ...
                    if (BalanceUnits > 1)
                    {
                        ...
                        drNew["ScripName"] = dr["ScripName"].ToString();
                        drNew["FolioNum"] = dr["FolioNum"].ToString();
                        drNew["Category"] = dr["Category"].ToString();
                        drNew["SubCategory"] = dr["SubCategory"].ToString();
                        ...
                        drNew["HoldStartDate"] = DateTime.Parse(dtBuy.Compute("MIN(TransactionDate)", "FolioNum='" + dr["FolioNum"].ToString() + "' AND ScripCode='" + dr["ScripCode"].ToString() + "' AND Units<>0").ToString()).ToString("dd-MMM-yy");
                        ...
                        drNew["PurUnits"] = decimal.Parse(dtBuy.Compute("Sum(UnitsBefore)", "FolioNum='" + dr["FolioNum"].ToString() + "' AND ScripCode='" + dr["ScripCode"].ToString() + "' AND TranxnTypeCode<>'DVR' ").ToString());
                        drNew["TotalUnits"] = decimal.Parse(dtBuy.Compute("Sum(UnitsBefore)", "FolioNum='" + dr["FolioNum"].ToString() + "' AND ScripCode='" + dr["ScripCode"].ToString() + "'").ToString());
                        ...
                        if (dtBuy.Select("FolioNum='" + dr["FolioNum"].ToString() + "' AND ScripCode='" + dr["ScripCode"].ToString() + "' AND TranxnTypeCode='DVR'").Count() > 0)
                        {
                            ...
                            drNew["DVRUnits"] = decimal.Parse(dtBuy.Compute("Sum(UnitsBefore)", "FolioNum='" + dr["FolioNum"].ToString() + "' AND ScripCode='" + dr["ScripCode"].ToString() + "' AND TranxnTypeCode='DVR'").ToString());
                        }
                        else
                        {
                            drNew["DVR"] = 0;
        ...
        public DataSet CreateCustomerMFReturnsRealized(int C_CustomerId, string PortfolioIds, DateTime? FromDate, DateTime ToDate)
        {
            DataTable dtTranxn = MFNetPositionDao.GetCustomerMFTransactions(C_CustomerId, PortfolioIds, FromDate, ToDate).Tables[0];
            ...
            dtMFReturnsHolding.Columns.Add("CurrentValue", typeof(decimal));
            dtMFReturnsHolding.Columns.Add("DVRUnits", typeof(decimal));
            dtMFReturnsHolding.Columns.Add("SoldUnits", typeof(decimal));
            dtMFReturnsHolding.Columns.Add("RedeemedAmt", typeof(decimal));
            dtMFReturnsHolding.Columns.Add("DVR", typeof(decimal));
            dtMFReturnsHolding.Columns.Add("DVP", typeof(decimal));
            dtMFReturnsHolding.Columns.Add("TotalPL", typeof(decimal));
            dtMFReturnsHolding.Columns.Add("ABS");
            dtMFReturnsHolding.Columns.Add("XIRR");
            dtMFReturnsHolding.Columns.Add("Category");
            dtMFReturnsHolding.Columns.Add("SubCategory");
            dtMFReturnsHolding.Columns.Add("HoldStartDate");
            dtMFReturnsHolding.Columns.Add("TotalDiv", typeof(decimal));
            ...
            if (dtTranxn.Rows.Count > 0)
            {
                ...
                foreach (DataRow dr in dtSchemeList.Rows)
                {
                    ...
                    if (dtBuy.Select("FolioNum='" + dr["FolioNum"].ToString() + "' AND ScripCode='" + dr["ScripCode"].ToString() + "'").Count() > 0)
                        drNew["InvestedCost"] = decimal.Parse(dtBuy.Compute("Sum(CostOfSales)", "FolioNum='" + dr["FolioNum"].ToString() + "' AND ScripCode='" + dr["ScripCode"].ToString() + "'").ToString());
                    else
                    ...
                    if (dtSell.Select("FolioNum='" + dr["FolioNum"].ToString() + "' AND ScripCode='" + dr["ScripCode"].ToString() + "'").Count() > 0)
                    {
                        ...
                        drNew["SoldUnits"] = decimal.Parse(dtSell.Compute("Sum(UnitsBefore)", "FolioNum='" + dr["FolioNum"].ToString() + "' AND ScripCode='" + dr["ScripCode"].ToString() + "'").ToString());
                    }
                    else
                    {
                        drNew["RedeemedAmt"] = 0;
                    ...
                    drNew["TotalDiv"] = decimal.Parse(drNew["DVR"].ToString()) + decimal.Parse(drNew["DVP"].ToString());

                    drNew["TotalPL"] = decimal.Parse(drNew["RedeemedAmt"].ToString()) + decimal.Parse(drNew["CurrentValue"].ToString()) - decimal.Parse(drNew["InvestedCost"].ToString()) + decimal.Parse(drNew["DVP"].ToString());

                    if (decimal.Parse(drNew["InvestedCost"].ToString()) != 0)
                        drNew["ABS"] = Math.Round((decimal.Parse(drNew["TotalPL"].ToString()) / (decimal.Parse(drNew["InvestedCost"].ToString()))) * 100, 2);
        ...
        {
            DataTable dtTranxn = MFNetPositionDao.GetCustomerMFTransactions(C_CustomerId, PortfolioIds, null, ToDate).Tables[0];
        ...
        {
            DataTable dtTranxn = MFNetPositionDao.GetCustomerMFTraxnReport(C_CustomerId, PortfolioIds, FromDate, ToDate).Tables[0];
            return dtTranxn;
        }
