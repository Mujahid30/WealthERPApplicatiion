...
namespace BoOnlineOrderManagement
{
    public class OnlineNCDBackOfficeBo
    {
        ...
        public DataSet GetAdviserIssueListClosed(string product, int adviserId)
        {
            ...
            try
            {
                return onlineNCDBackOfficeDao.GetAdviserIssueListClosed(product, adviserId);
            }
            catch (BaseApplicationException Ex)
            {
                throw Ex;
        ...
        //    try
        //    {
        //        return onlineNCDBackOfficeDao.BindNcdSubCategory(type);
        //    }
        //    catch (BaseApplicationException Ex)
        //    {
        //        throw Ex;
        ...
        public DataSet GetIssuerIssue(int advisorId, string product, int businessChannel, string orderStatus, string subCategoryCode)
        {
            ...
            try
            {
                return onlineNCDBackOfficeDao.GetIssuerIssue(advisorId, product, businessChannel, orderStatus, subCategoryCode);
            }
            catch (BaseApplicationException Ex)
            {
                throw Ex;
        ...
        public DataSet GetAdviserOrders(int IssueId, string Product, int adviserid, int BusinessChannel, string userType, string agentCode, string category)
        {
            ...
            try
            {
                return onlineNCDBackOfficeDao.GetAdviserOrders(IssueId, Product, adviserid, BusinessChannel, userType, agentCode, category);
            }
            catch (BaseApplicationException Ex)
            {
                throw Ex;
        ...
        public DataTable GetOrderMissMatchDetails(int issueid, string orderstapcode, string category, int isOnline, DateTime from, DateTime to, int type)
        {
            ...
            {
                onlineNCDBackOfficeDao = new OnlineNCDBackOfficeDao();
                dtGetOrderMissMatchDetails = onlineNCDBackOfficeDao.GetOrderMissMatchDetails(issueid, orderstapcode, category, isOnline, from, to, type);
            }
            catch (BaseApplicationException Ex)
            {
                throw Ex;
