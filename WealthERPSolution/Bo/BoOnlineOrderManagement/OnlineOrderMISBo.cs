...
namespace BoOnlineOrderManagement
{
    public class OnlineOrderMISBo
    {
        ...
        public DataTable GetAdviserCustomerTransaction(int adviserId, int AmcCode, DateTime dtFrom, DateTime dtTo, int PageSize, int CurrentPage, string CustomerNamefilter, string custCode, string panNo, string folioNo, string schemeName, string type, string dividentType, string fundName, int orderNo, out int RowCount, int Isdemat)
        {
            ...
            OnlineOrderMISDao OnlineOrderMISDao = new OnlineOrderMISDao();
            dtGetAdviserCustomerTransaction = OnlineOrderMISDao.GetAdviserCustomerTransaction(adviserId, AmcCode, dtFrom, dtTo, PageSize, CurrentPage, CustomerNamefilter, custCode, panNo, folioNo, schemeName, type, dividentType, fundName, orderNo, out RowCount, Isdemat);
