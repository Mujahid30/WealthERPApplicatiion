    ...
    public class CustomerTransactionBo
    {
        ...
        public List<MFTransactionVo> GetRMCustomerMFTransactions(int RMId, int AdviserID, int GroupHeadId,int IsfolioOnline, DateTime From, DateTime To, int Manage, int AccountId, bool isCustomerTransactionOnly, int SchemePlanCode, int AmcCode, string Category, int A_AgentCodeBased, string AgentCode, string UserType)
        {
            ...
            try
            {
                ...
                mfTransactionsList = customerTransactionDao.GetRMCustomerMFTransactions(RMId, AdviserID, GroupHeadId,IsfolioOnline, From, To, Manage, AccountId, isCustomerTransactionOnly, SchemePlanCode, AmcCode, Category,A_AgentCodeBased,AgentCode, UserType);
        ...
        public List<MFTransactionVo> GetCustomerTransactionsBookSIP(int AdviserID, int customerId, int SystematicId, int IsSourceAA, int AccountId, int SchemePlanCode,int amount)
        {
            ...
            try
            {
                ...
                mfTransactionsBookList = customerTransactionDao.GetCustomerTransactionsBookSIP( AdviserID,customerId,SystematicId,IsSourceAA,AccountId,SchemePlanCode,amount);
