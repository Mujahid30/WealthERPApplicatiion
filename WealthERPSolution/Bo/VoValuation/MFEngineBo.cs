...
namespace BoValuation
{
    public class MFEngineBo
    {
       ...
       protected DataTable TransactionBalanceProcess(DataSet dsTransactionList)
       {
           ...
           dtTransactionDetails.Columns.Add("CMFT_MFTransId", typeof(Int32));
           dtTransactionDetails.Columns.Add("CMFA_AccountId", typeof(Int32));
           dtTransactionDetails.Columns.Add("PASP_SchemePlanCode", typeof(Int32));
           dtTransactionDetails.Columns.Add("CMFT_TransactionDate", typeof(DateTime));
           dtTransactionDetails.Columns.Add("CMFT_Price", typeof(double));
           dtTransactionDetails.Columns.Add("CMFT_Units", typeof(double));
           dtTransactionDetails.Columns.Add("CMFT_Amount", typeof(double));
           dtTransactionDetails.Columns.Add("CMFT_STT", typeof(double));
           ...
           dtTransactionDetails.Columns.Add("CMFTB_AvgCostBalRETURN", typeof(double));
           dtTransactionDetails.Columns.Add("CMFTB_TotalCostBalRETURN", typeof(double));
           dtTransactionDetails.Columns.Add("CMFTB_Age", typeof(Int32));
           dtTransactionDetails.Columns.Add("CMFTB_DivPayout", typeof(double));
           dtTransactionDetails.Columns.Add("CMFTB_DVRUnitsAllocation_Share", typeof(double));
           dtTransactionDetails.Columns.Add("CMFTB_DVRUnits_Contributed", typeof(double));
           dtTransactionDetails.Columns.Add("CMFTB_InsertUpdate_Flag", typeof(Int16));
           //double avgValue=0;
               ...
               if (dr["WMTT_TransactionClassificationCode"].ToString() != "SEL" && dr["WMTT_TransactionClassificationCode"].ToString() != "DVP")
               {
                   ...
                   if (buyUnits != 0)
                   {
                       if (buyUnits == sellUnits)
                       {
                           ...
                           age = span.TotalDays;
                           dtMFTrasactionSellPair = FillSellPairedDataSet(sellUnits, age, sellId, double.Parse(dr["CMFT_MFTransId"].ToString()), sellPrice, double.Parse(dr["CMFT_Price"].ToString()));
                           break;
                       }
                       ...
                       else if (buyUnits < sellUnits)
                       {
                           ...
                           span = sellTransactiondate - DateTime.Parse(dr["CMFT_TransactionDate"].ToString());
                           age = span.TotalDays;
                           dtMFTrasactionSellPair = FillSellPairedDataSet(buyUnits, age, sellId, double.Parse(dr["CMFT_MFTransId"].ToString()), sellPrice, double.Parse(dr["CMFT_Price"].ToString()));
       ...
       protected DataTable FillSellPairedDataSet(double units, double age, double sellId, double buyId, double sellPrice, double buyPrice)
       {
