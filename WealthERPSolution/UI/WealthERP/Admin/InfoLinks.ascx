            ...
            <asp:GridView ID="gvAdviserLinks" ShowHeader="false" runat="server" DataKeyNames="AL_LinkId" 
                AutoGenerateColumns="False" BorderStyle="None" BorderColor="Transparent"
                        ...
                        <Columns>
                                ...
                                <asp:TemplateField>
                                    <ItemTemplate>  
                                        <asp:LinkButton ID="lnkLinks" runat="server" CommandArgument="<%# ((GridViewRow) Container).RowIndex %>" Text='<%# Eval("AL_AltLinkName").ToString() %>' CommandName="NavigateToLink" ></asp:LinkButton>
                                        <br /><br />
                                    </ItemTemplate>                           
