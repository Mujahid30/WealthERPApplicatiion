...
<div id="dvAssocicateReport" runat="server" visible="false">
    ...
    <table id="tblMenu" cellspacing="0" width="100%">
        <tr>
            ...
            <td id="tdcbIsDummyAgent" runat="server">
                        ...
                        <tr>
                            ...
                            <td align="right" style="padding-bottom: 2px;">
                                <asp:ImageButton ID="IbReceibaleReport" ImageUrl="~/App_Themes/Maroon/Images/Export_Excel.png"
                                    ...
                                    Height="25px" Width="25px" Visible="false" OnClick="btnExportReceivableReport_OnClick">
                                </asp:ImageButton>
                            </td>
                        </tr>
                    </table>
        ...
        <tr>
            ...
            <td>
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator6" ControlToValidate="rptTxtFromDate"
                    CssClass="rfvPCG" ErrorMessage="<br />Please select a  Date" Display="Dynamic"
                    ValidationGroup="vgbtnSubmit" runat="server" InitialValue=""></asp:RequiredFieldValidator>
            ...
            <td colspan="2" class="rightField">
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator7" ControlToValidate="rpttxtToDate"
                    ValidationGroup="vgbtnSubmit" CssClass="rfvPCG" ErrorMessage="<br />Please select a Date"
                    Display="Dynamic" runat="server" InitialValue=""></asp:RequiredFieldValidator>
                ...
                <asp:CompareValidator ID="CompareValidator9" runat="server" ErrorMessage="<br/>To Date should not less than From Date"
                    Type="Date" ControlToValidate="rpttxtToDate" ControlToCompare="rpttxtFromDate"
                    Operator="GreaterThanEqual" CssClass="cvPCG" Display="Dynamic" ValidationGroup="vgbtnSubmit"></asp:CompareValidator>
            </td>
                    ...
                    <telerik:RadGrid ID="rgReceivableReport" runat="server" GridLines="None" AutoGenerateColumns="False"
                        ...
                        <MasterTableView ShowGroupFooter="true" Width="100%">
                            <GroupByExpressions>
                                ...
                                <telerik:GridGroupByExpression>
                                    <SelectFields>
                                        <telerik:GridGroupByField FieldAlias="WCD_BrokerName" FieldName="WCD_BrokerName"
