<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ViewMFPortfolioValuation.ascx.cs" Inherits="WealthERP.CustomerPortfolio.ViewMFPortfolioValuation" %>
                        ...
                        <tr>
                            <td>
                                <div id="dvNotionalPortfolio" runat="server">
                                    ...
                                    <asp:GridView ID="gvMFPortfolioNotional" runat="server"  AutoGenerateColumns="False"
                                        CellPadding="4" DataKeyNames="SI.No" EnableViewState="true" CssClass="GridViewStyle"
                                        ShowFooter="True"  OnRowCommand="gvMFPortfolioNotional_RowCommand"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField ItemStyle-Wrap="false">
                                                <HeaderTemplate>
                                                    ...
                                                    <asp:TextBox ID="txtNotionalSchemeNameSearch" runat="server" CssClass="GridViewtxtField"
                                                        onkeydown="return JSdoPostback(event,'ctrl_ViewMutualFundPortfolioValuation_btnPortfolioNotionalSearch');" />
                                                </HeaderTemplate>
                                                <ItemTemplate>
                                            ...
                                            <asp:BoundField DataField="CurrentHoldings" HeaderText="Units OutStanding" ItemStyle-HorizontalAlign="Right"
                                                HeaderStyle-Wrap="false" />
                                                <asp:BoundField DataField="OriginalUnits" HeaderText="Original Units OutStanding" ItemStyle-HorizontalAlign="Right"
                                                HeaderStyle-Wrap="false" />
                                                <asp:BoundField DataField="DividendUnits" HeaderText="Dividend Units OutStanding" ItemStyle-HorizontalAlign="Right"
                                                HeaderStyle-Wrap="false" />
                                             <asp:BoundField DataField="AverageCost" HeaderText="Average Cost" ItemStyle-HorizontalAlign="Right"
                                                HeaderStyle-Wrap="false" />
                                            <asp:BoundField DataField="AcqCost" HeaderText="Acq Cost" ItemStyle-HorizontalAlign="Right"
                                                HeaderStyle-Wrap="false" />
                                            <asp:BoundField DataField="NetAcqCost" HeaderText="Net Acq Cost" ItemStyle-HorizontalAlign="Right"
                                                HeaderStyle-Wrap="false" />
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField ItemStyle-Wrap="false">
                                                <HeaderTemplate>
                                                    ...
                                                    <asp:TextBox ID="txtSchemeNameSearch" runat="server" CssClass="GridViewtxtField"
                                                        onkeydown="return JSdoPostback(event,'ctrl_ViewMutualFundPortfolioValuation_btnPortfolioSearch');" />
                                                </HeaderTemplate>
                                                <ItemTemplate>
                                            ...
                                            <asp:TemplateField ItemStyle-Wrap="false">
                                                <HeaderTemplate>
                                                    ...
                                                    <asp:TextBox ID="txtFolioSearch" runat="server" CssClass="GridViewtxtField" onkeydown="return JSdoPostback(event,'ctrl_ViewMutualFundPortfolioValuation_btnPortfolioSearch');" />
                                                </HeaderTemplate>
                                                <ItemTemplate>
                                            ...
                                            <asp:BoundField DataField="CurrentValue" HeaderText="Curr Value" ItemStyle-HorizontalAlign="Right"
                                             ...
                                             <asp:BoundField DataField="TotalUnitsSold" HeaderText="Units Sold" ItemStyle-HorizontalAlign="Right"
                                                HeaderStyle-Wrap="false">
                                                <ItemStyle HorizontalAlign="Right"></ItemStyle>
                                            </asp:BoundField>
                        ...
                        <tr>
                            <td>
                                <div id="dvRealizedPortfolio" runat="server">
                                    ...
                                    <asp:GridView ID="gvMFPortfolioRealized" runat="server"  AutoGenerateColumns="False"
                                        CellPadding="4" DataKeyNames="SI.No" EnableViewState="true" CssClass="GridViewStyle"
                                        ShowFooter="True" OnRowDataBound="gvMFPortfolioRealized_RowDataBound"
                                ...
                                <ItemStyle HorizontalAlign="Right"></ItemStyle>
                                            ...
                                            <asp:TemplateField ItemStyle-Wrap="false">
                                                <HeaderTemplate>
                                                    ...
                                                    <br />
                                                    <asp:TextBox ID="txtRealizedSchemeNameSearch" runat="server" CssClass="GridViewtxtField"
                                                        onkeydown="return JSdoPostback(event,'ctrl_ViewMutualFundPortfolioValuation_btnPortfolioRealizedSearch');" />
                                                </HeaderTemplate>
                                                <ItemTemplate>
                                ...
                                ItemStyle-Width="325" />--%>
                                            <asp:TemplateField ItemStyle-Wrap="false">
                                             ...
                                             <asp:BoundField DataField="OriginalUnitsSold" HeaderText="Original Units Sold" ItemStyle-HorizontalAlign="Right"
                                                HeaderStyle-Wrap="false">
                                                <ItemStyle HorizontalAlign="Right"></ItemStyle>
                                            </asp:BoundField>
                                             <asp:BoundField DataField="DivUnitsSold" HeaderText="Reinvested Units Sold" ItemStyle-HorizontalAlign="Right"
                                                HeaderStyle-Wrap="false">
                                                <ItemStyle HorizontalAlign="Right"></ItemStyle>
                                            </asp:BoundField>
                                            <asp:BoundField DataField="TotalUnitsSold" HeaderText="Total Units Sold" ItemStyle-HorizontalAlign="Right"
                                                HeaderStyle-Wrap="false">
                                                <ItemStyle HorizontalAlign="Right"></ItemStyle>
                                            </asp:BoundField>
                                            ...
                                            <asp:BoundField DataField="SalesProceeds" HeaderText="Sale Proceeds" ItemStyle-HorizontalAlign="Right"
                                                HeaderStyle-Wrap="false">
                                                <ItemStyle HorizontalAlign="Right"></ItemStyle>
                                            </asp:BoundField>
                                            ...
                                            <asp:BoundField DataField="TotalRealizedPL" HeaderText="Total Realized P/L (Rs)" ItemStyle-HorizontalAlign="Right"
                                                HeaderStyle-Wrap="false">
                                                <ItemStyle HorizontalAlign="Right"></ItemStyle>
                                            </asp:BoundField>
