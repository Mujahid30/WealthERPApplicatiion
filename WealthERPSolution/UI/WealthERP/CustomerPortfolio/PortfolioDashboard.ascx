...
<table>
                ...
                <table border="1" style="border-collapse: collapse; width: 100%;">
                    ...
                    <tr>
                        <td rowspan="2" class="style1">
                            <asp:Chart ID="chrtTotalAssets" runat="server" BackColor="Transparent" Width="400px" Height="200px">
                                <Series>
    ...
    <asp:GridView ID="gvAbsoluteReturn" runat="server" AllowSorting="True" AutoGenerateColumns="False"
                    ...
                    <asp:BoundField DataField="AmountInvested" HeaderText="Amount Invested" ItemStyle-HorizontalAlign="Right" />
                     ...
                     <%--<asp:BoundField DataField="PercentChange" HeaderText="%Change" ItemStyle-HorizontalAlign="Right" />--%>
                    <asp:TemplateField HeaderText="%Change" ItemStyle-HorizontalAlign="Right" FooterStyle-HorizontalAlign="Right">
                                    <ItemTemplate>
                                        <asp:Label ID="lblBrokAmt" runat="server" CssClass="CmbField" Text='<%#Eval("PercentChange") %>'>
                                        </asp:Label>
                                    </ItemTemplate>
                                     <FooterTemplate>
                                        <asp:Label ID="lblTotalPerChange" runat="server" CssClass="Field" Font-Bold="true" 
