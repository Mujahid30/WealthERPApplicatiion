    ...
    <ContentTemplate>
        ...
        <table width="100%" class="TableBackground">
            ...
            <tr>
                ...
                <td class="rightField" colspan="2">
                    <span style='font-size: 8px; font-weight: normal' class='FieldName'>Enter few characters
                        of Scrip Particular</span><br />
                    <asp:RequiredFieldValidator ID="rfvScrip" ControlToValidate="txtScrip" ErrorMessage="Enter few characters of Scrip Particular"
                        CssClass="rfvPCG" runat="server" InitialValue="" ValidationGroup="EQ">
            ...
            <tr id="trTransactionMode" runat="server">
                ...
                <td class="rightField" colspan="2">
                    <asp:RadioButton ID="rbtnDelivery" AutoPostBack="true" runat="server" CssClass="txtField"
                        Text="For Delivery " GroupName="TransactionMode" Checked="true" OnCheckedChanged="rbtnDelivery_CheckedChanged" />
                    <asp:RadioButton ID="rbtnSpeculation" runat="server" AutoPostBack="true" CssClass="txtField"
                        Text="For Speculation" GroupName="TransactionMode" OnCheckedChanged="rbtnSpeculation_CheckedChanged" />
                </td>
                <td>
                </td>
            </tr>
            <tr>
                ...
                <td class="rightField" colspan="3">
                    ...
                    <asp:CompareValidator Display="Dynamic" ID="CompareValidator1" runat="server" ControlToValidate="ddlTransactionType"
                        ...
                        ValueToCompare="Select Transaction" ValidationGroup="EQ"></asp:CompareValidator>
                </td>
            </tr>
            <tr>
                <td class="leftField">
            ...
            <tr>
                ...
                <td style="width: 20px">
                    ...
                    <div id="divTradeAcc" runat="server" class="dvInLine">
                        ...
                        <br />
                        <asp:CompareValidator Display="Dynamic" ID="CompareValidator3" runat="server" ControlToValidate="ddlTradeAcc"
                ...
                <td colspan="4">
                    <tr id="trTradeDate" runat="server">
                        ...
                        <td class="rightField" style="width: 400px">
                            <asp:TextBox ID="txtTradeDate" runat="server" CssClass="txtField" OnTextChanged="txtTradeDate_TextChanged"
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator3" ControlToValidate="txtTradeDate"
                                CssClass="rfvPCG" ErrorMessage="<br />Please select a Trade Date" Display="Dynamic"
                        ...
                        <td class="rightField">
                            <asp:Button ID="btnUsePrice" runat="server" Text="Use the price" CssClass="PCGMediumButton"
                    ...
                    <tr id="trRate" runat="server">
                        ...
                        <td class="rightField" colspan="3">
                            <asp:TextBox ID="txtRate" runat="server" CssClass="txtField" MaxLength="18" OnTextChanged="txtRate_TextChanged"
                                AutoPostBack="true"></asp:TextBox>
                            <span id="Span8" class="spnRequiredField">*</span>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator4" ControlToValidate="txtRate"
                                CssClass="rfvPCG" ErrorMessage="<br />Please enter a Rate" Display="Dynamic"
                                runat="server" InitialValue="" ValidationGroup="EQ">
                            </asp:RequiredFieldValidator>
                    ...
                    <tr id="trNoShares" runat="server">
                        ...
                        <td class="rightField" colspan="3">
                            <asp:TextBox ID="txtNumShares" runat="server" CssClass="txtField" MaxLength="18"
                                AutoPostBack="true" OnTextChanged="txtNumShares_TextChanged"></asp:TextBox>
                            <span id="Span9" class="spnRequiredField">*</span>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator5" ControlToValidate="txtNumShares"
                                CssClass="rfvPCG" ErrorMessage="<br />Please enter the number of shares" Display="Dynamic"
                                runat="server" InitialValue="" ValidationGroup="EQ">
                            </asp:RequiredFieldValidator>
                            <asp:RegularExpressionValidator ID="RegularExpressionValidator4" ControlToValidate="txtNumShares"
                                CssClass="rfvPCG" Display="Dynamic" runat="server" ErrorMessage="Not acceptable format"
                                ValidationExpression="^\d*(\.(\d{0,4}))?$"></asp:RegularExpressionValidator>
                        </td>
                    </tr>
                    ...
                    <tr id="trBrokerage" runat="server">
                        <td class="leftField">
                            <asp:Label ID="lblBrokerage" runat="server" Text="Brokerage (Per Unit) :" CssClass="FieldName"
                                MaxLength="18"></asp:Label>
                        </td>
                        <td class="rightField" colspan="3">
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" ControlToValidate="txtBrokerage" CssClass="rfvPCG"
                        ...
                        InitialValue="" ValidationGroup="EQ">
                            ...
                            <asp:RegularExpressionValidator ID="RegularExpressionValidator1" ControlToValidate="txtBrokerage"
                                CssClass="rfvPCG" Display="Dynamic" runat="server" ErrorMessage="Not acceptable format."
                                ValidationExpression="^\d*(\.(\d{0,4}))?$"></asp:RegularExpressionValidator>
                        </td>
                    </tr>
                    <tr id="trOthers" runat="server">
                        <td class="leftField">
                            <asp:Label ID="lblOther" runat="server" Text="Other Charges (Per Unit) :" CssClass="FieldName"
                                MaxLength="18"></asp:Label>
                        </td>
                        <td class="rightField" colspan="2">
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator8" ControlToValidate="txtOtherCharge"
                        ...
                        InitialValue="" ValidationGroup="EQ">
                                ...
                                <asp:RegularExpressionValidator ID="RegularExpressionValidator2" ControlToValidate="txtOtherCharge"
                                    CssClass="rfvPCG" Display="Dynamic" runat="server" ErrorMessage="Not acceptable format."
                                    ValidationExpression="^\d*(\.(\d{0,4}))?$"></asp:RegularExpressionValidator>
                            </div>
                    ...
                    <tr id="trRateInc" runat="server">
                        ...
                        <td class="rightField" colspan="3">
                            ...
                            <asp:CompareValidator ID="CompareValidator12" runat="server" ErrorMessage="<br />Enter a numeric value"
                                ...
                                CssClass="rfvPCG" Display="Dynamic" ValidationGroup="EQ"></asp:CompareValidator>
                        </td>
                    </tr>
                    <tr id="trTotal" runat="server">
                        ...
                        <td class="rightField" colspan="3">
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator12" ControlToValidate="txtTotal"
                                ...
                                CssClass="rfvPCG" InitialValue="" ValidationGroup="EQ">
                            </asp:RequiredFieldValidator>
                            <asp:CompareValidator ID="CompareValidator13" runat="server" ErrorMessage="<br />Enter a numeric value"
                                ...
                                CssClass="rfvPCG" ValidationGroup="EQ"></asp:CompareValidator>
                        </td>
                    </tr>
                </td>
            </tr>
