<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PortfolioReports.ascx.cs"
    Inherits="WealthERP.Reports.PortfolioReports" %>
...
<table border="0" width="100%">
    <tr>
        <td>
            <asp:Label ID="Label7" runat="server" CssClass="HeaderTextSmall" Text="Multi asset report"></asp:Label>
            <hr />
        </td>
    </tr>
                ...
                <ajaxToolkit:TabPanel ID="TabPanel1" runat="server" HeaderText="Group" Visible="true">
                    ...
                    <ContentTemplate>
                        <table border="0" id="tblGroup" style="display: block;">
                            ...
                            <tr>
                                <td colspan="2">
                                    <%-- <asp:Label ID="lblSelected" runat="server" CssClass="FieldName" Text="Selected Group Head :"></asp:Label>
                                    <asp:Label ID="lblGroupHeadName" runat="server" CssClass="FieldName" Text=""></asp:Label>--%>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="2">
                    ...
                    <ContentTemplate>
                        <table border="0" id="tblIndividual">
                            <tr id="trStepIndi" runat="server">
                                <td colspan="2">
                                    <asp:Label ID="Label6" runat="server" CssClass="HeaderTextSmall" Style='font-weight: normal;'
                                        Text="Step 1 : Select Customer"></asp:Label>
                                </td>
                            </tr>
