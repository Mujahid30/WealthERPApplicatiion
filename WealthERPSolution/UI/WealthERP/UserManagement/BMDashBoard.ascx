<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="BMDashBoard.ascx.cs"
    Inherits="WealthERP.UserManagement.BMDashBoard" %>
<html>
<head>
...
<body>
    ...
    <table style="width: 100%;">
        ...
        <tr>
            <td>
                <asp:GridView ID="gvBMDashBoardGrid" runat="server" AllowSorting="True" AutoGenerateColumns="False"
                    CellPadding="4" EnableViewState="false" AllowPaging="True" ShowFooter="true"
                    CssClass="GridViewStyle" Width="550px" Height="330px" OnRowDataBound="BMDashBoardGrid_RowDataBound"
                    ...
                    <Columns>
                        <asp:TemplateField HeaderText="Asset" ItemStyle-ForeColor="Black">
                            ...
                            <ItemTemplate>
                                <asp:Label ID="lblSavingReq" runat="server" CssClass="GridViewCmbFieldforBM" Text='<%#Eval("Asset") %>'
                                    ForeColor="Black">
                                </asp:Label>
                            </ItemTemplate>
                            <FooterTemplate>
                                <asp:Label ID="lblTotalText" runat="server" CssClass="Field" Font-Bold="true" ForeColor="White"
                                    Text="">
                                </asp:Label>
                            </FooterTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Current Value (Rs.)" HeaderStyle-HorizontalAlign="Right">
                            ...
                            <ItemTemplate>
                                <asp:Label ID="lblSavingReq" runat="server" CssClass="GridViewCmbFieldforBM" Text='<%#Eval("CurrentValue") %>'
                                    ForeColor="Black">
                                </asp:Label>
                            </ItemTemplate>
                            <FooterTemplate>
                                <asp:Label ID="lblTotalValue" runat="server" CssClass="Field" Font-Bold="true" ForeColor="White"
                                    Text="">
                                </asp:Label>
                            </FooterTemplate>
                        </asp:TemplateField>
            ...
            <td>
                <asp:Chart ID="ChartBranchAssets" runat="server" Width="400px" Height="200px" BackColor="Transparent">
                    <Series>
                        <asp:Series Name="seriesBranchAssets" LabelBackColor="Red" ChartType="Pie" LegendText="#VALX"
                            YValueType="Double">
                    ...
                    <ChartAreas>
                        <asp:ChartArea Name="ChartArea1">
                            <Area3DStyle Enable3D="True" Inclination="30" PointDepth="180" WallWidth="30" LightStyle="Simplistic"
                                Rotation="90" Perspective="30" IsRightAngleAxes="true" IsClustered="true" />
                        </asp:ChartArea>
                    </ChartAreas>
                </asp:Chart>
                <br />
    ...
    <table style="width: 100%;">
        ...
        <tr>
            <td style="vertical-align: top">
                <asp:GridView ID="gvRMCustNetworth" runat="server" Width="550px" AutoGenerateColumns="False"
                    GridLines="Both" CellPadding="4" EnableViewState="true" AllowPaging="True" ShowFooter="true"
                    ...
                    <asp:LinkButton ID="lnkRMName" runat="server" Text='<%# Eval("RmName") %>' 
                        ...
                        <asp:BoundField DataField="Customer_networth" DataFormatString="{0:n}" HtmlEncode="false"
                            HeaderText="NetWorth" ItemStyle-HorizontalAlign="Right">
                            <ItemStyle HorizontalAlign="Right"></ItemStyle>
                        </asp:BoundField>
                    </Columns>
                </asp:GridView>
            ...
            <td>
                <asp:Chart ID="CharttopfiveRMCustNetworth" runat="server" BackColor="#F1EDED" Height="300px"
                    Width="450px">
                    <Series>
                        <asp:Series Name="RMCustNet" XValueMember="Customers" YValueMembers="NetWorth" Font="Microsoft Sans Serif, 10pt, style=Bold">
                        </asp:Series>
                    </Series>
                    <ChartAreas>
                        <asp:ChartArea Name="ChartArea1">
    ...
    <table style="width: 100%;">
        ...
        <tr>
            <td style="vertical-align: top">
                <asp:GridView ID="gvCustNetWorth" runat="server" AllowSorting="True" Width="550px"
                    AutoGenerateColumns="False" GridLines="Both" CellPadding="4" EnableViewState="true"
                    AllowPaging="True" ShowFooter="true" CssClass="GridViewStyle" ToolTip="Top 5 Customers Networth GridView"
                    DataKeyNames="CustomerId" OnSelectedIndexChanged="gvCustNetWorth_SelectedIndexChanged">
                    <FooterStyle CssClass="FooterStyle" />
                    <RowStyle CssClass="RowStyle" />
                    <PagerStyle HorizontalAlign="Center" CssClass="PagerStyle" />
                    <SelectedRowStyle CssClass="SelectedRowStyle" />
                    ...
                    <Columns>
                        <asp:TemplateField runat="server" HeaderText="Customer">
                            <ItemTemplate>
                                <asp:LinkButton ID="lnkCustomer" runat="server" CssClass="CmbField" Text='<%# Eval("Customer") %>'
                        ...
                        <asp:BoundField DataField="Asset" HeaderText="Asset" DataFormatString="{0:n}" HtmlEncode="false"
                            ItemStyle-HorizontalAlign="Right" />
                        <asp:BoundField DataField="Liabilities" DataFormatString="{0:n}" HtmlEncode="false"
                            HeaderText="Liabilities" ItemStyle-HorizontalAlign="Right" />
                        <asp:BoundField DataField="Networth" DataFormatString="{0:n}" HtmlEncode="false"
                            HeaderText="NetWorth" ItemStyle-HorizontalAlign="Right" />
                    </Columns>
                </asp:GridView>
            </td>
            <td>
                <asp:Chart ID="ChartCustomerNetworth" runat="server" BackColor="#F1EDED" Height="300px"
                    Width="450px">
                    <Series>
                        <asp:Series Name="CustNetworth" Font="Microsoft Sans Serif, 10pt, style=Bold" XValueMember="Customers"
                            YValueMembers="NetWorth">
                        </asp:Series>
                    </Series>
                    <ChartAreas>
                        <asp:ChartArea Name="ChartArea1">
