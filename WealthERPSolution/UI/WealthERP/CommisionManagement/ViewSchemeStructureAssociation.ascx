    ...
    <ContentTemplate>
                            ...
                            <tr>
                                ...
                                <td align="right">
                                    <asp:ImageButton ID="ibtExportSummary" ImageUrl="~/App_Themes/Maroon/Images/Export_Excel.png"
                                        ...
                                        OnClick="ibtExportSummary_OnClick" Height="25px" Width="25px"></asp:ImageButton>
                                </td>
                            </tr>
                        </table>
                    </div>
        ...
        <div>
            <telerik:RadGrid ID="rgvSchemeToStruct" runat="server" GridLines="None" AutoGenerateColumns="False"
                ...
                OnItemDataBound="rgvSchemeToStruct_ItemDataBound" Skin="Telerik" EnableEmbeddedSkins="false"
                Width="100%" AllowFilteringByColumn="true" OnNeedDataSource="rgvSchemeToStruct_NeedDataSource"
                    ...
                    <Columns>
                     <telerik:GridBoundColumn HeaderStyle-Width="120px" HeaderText="AMC Name" DataField="PA_AMCName"
                        ...
                        <telerik:GridTemplateColumn HeaderStyle-Width="120px" HeaderText="Commission Structure"
                            HeaderStyle-HorizontalAlign="left" DataField="ACSM_CommissionStructureName" UniqueName="ACSM_CommissionStructureName"
                            SortExpression="ACSM_CommissionStructureName" CurrentFilterFunction="Contains"
                            ShowFilterIcon="false" AutoPostBackOnFilter="true" FilterControlWidth="60%" FooterStyle-HorizontalAlign="Right">
                            <ItemTemplate>
                                <asp:LinkButton ID="lbtStruct" runat="server" OnClick="lbtStruct_Click" AutoPostBack="true"
                                    CssClass="" Width="300px" EnableEmbeddedSkins="false">                            
                                </asp:LinkButton>
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>
                        <telerik:GridDateTimeColumn HeaderStyle-Width="40px" HeaderText="Validity Start"
                            DataField="ACSTSM_ValidityStart" HeaderStyle-HorizontalAlign="Center" UniqueName="ACSTSM_ValidityStart"
                            SortExpression="ACSTSM_ValidityStart" CurrentFilterFunction="EqualTo" ShowFilterIcon="false"
