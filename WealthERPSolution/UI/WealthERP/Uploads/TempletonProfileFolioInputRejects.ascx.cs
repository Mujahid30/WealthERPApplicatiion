...
{
    public partial class TempletonProfileFolioInputRejects : System.Web.UI.UserControl
    {
        UserVo userVo;
        ...
        void BindRejectedRecordsGrid()
        {
            ...
            try
            {
                dsRejectedRecords = rejectedRecordsBo.GetProfileFolioInputRejects(processID, "TN", mypager.CurrentPage, out Count);
            }
            catch (Exception Ex)
            {
