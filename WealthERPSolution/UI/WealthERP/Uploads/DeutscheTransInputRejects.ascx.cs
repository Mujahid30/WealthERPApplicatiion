...
{
    public partial class DeutscheTransInputRejects : System.Web.UI.UserControl
    {
        UserVo userVo;
        ...
        void BindRejectedRecordsGrid()
        {
            ...
            try
            {
                dsRejectedRecords = rejectedRecordsBo.GetTransInputRejects(processID, "DT", mypager.CurrentPage, out Count);
            }
            catch (Exception Ex)
            {
                ...
                FunctionInfo.Add("Method", "DeutscheTransInputRejects.ascx:BindRejectedRecordsGrid()");
