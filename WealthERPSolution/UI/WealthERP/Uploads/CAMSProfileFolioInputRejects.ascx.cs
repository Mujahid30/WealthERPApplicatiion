...
{
    public partial class CAMSProfileFolioInputRejects : System.Web.UI.UserControl
    {
        UserVo userVo;
        ...
        void BindRejectedRecordsGrid()
        {
            ...
            try
            {
                dsRejectedRecords = rejectedRecordsBo.GetProfileFolioInputRejects(processID, "CA", mypager.CurrentPage, out Count);
            }
            catch (Exception Ex)
            {
                ...
                FunctionInfo.Add("Method", "CAMSProfileFolioInputRejects.ascx:BindRejectedRecordsGrid()");
