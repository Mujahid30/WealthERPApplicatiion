...
<table>
    <tr>
        <td class="HeaderCell">
            <asp:Label ID="lblHeader" runat="server" CssClass="HeaderTextBig" Text="Trail Commission Rejects"></asp:Label>
        </td>
    </tr>
    <tr>
        <td>
            ...
            <telerik:RadGrid ID="GVTrailTransactionRejects" runat="server" GridLines="None" AutoGenerateColumns="False"
                ...
                <MasterTableView DataKeyNames="CMFTCCS_Id,A_AdviserId,Adul_ProcessId" Width="100%"
                    ...
                    <Columns>
                        ...
                        <telerik:GridBoundColumn AllowFiltering="false" DataField="PASP_SchemePlanName" HeaderText="Scheme Name"
                        ...
                        <telerik:GridBoundColumn AllowFiltering="false" DataField="CMFTTCS_TransactionType"
                            HeaderText="Transaction Type" UniqueName="transactiontype">
                            <ItemStyle Width="" HorizontalAlign="left" Wrap="false" VerticalAlign="Top" />
                        </telerik:GridBoundColumn>
