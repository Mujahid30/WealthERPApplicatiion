    ...
    <telerik:RadGrid ID="gvCommissionReceiveRecon" runat="server" GridLines="None" AutoGenerateColumns="False"
        ...
        <MasterTableView AllowMultiColumnSorting="True" AutoGenerateColumns="false" CommandItemDisplay="None"
            ...
            <Columns>
                ...
                <telerik:GridBoundColumn HeaderStyle-Width="2%" HeaderText="Start Date"
                    DataField="transactiondate" UniqueName="transactiondate" SortExpression="transactiondate"
                    AutoPostBackOnFilter="true" ShowFilterIcon="false" CurrentFilterFunction="Contains"
                    DataFormatString="{0:d}" HeaderStyle-HorizontalAlign="Center">
                    <ItemStyle Width="140px" HorizontalAlign="Right" Wrap="false" VerticalAlign="Top" />
                </telerik:GridBoundColumn>
                <telerik:GridBoundColumn HeaderStyle-Width="2%" HeaderText="End Date"
                    DataField="TransactionAsOnDate" UniqueName="TransactionAsOnDate" SortExpression="TransactionAsOnDate"
                    AutoPostBackOnFilter="true" ShowFilterIcon="false" CurrentFilterFunction="Contains"
                    DataFormatString="{0:d}" HeaderStyle-HorizontalAlign="Center" Visible="false">
                    <ItemStyle Width="140px" HorizontalAlign="Right" Wrap="false" VerticalAlign="Top" />
                </telerik:GridBoundColumn>
                ...
                <telerik:GridBoundColumn HeaderStyle-Width="2%" HeaderText="Total NAV" DataField="CumNAv"
                 ...
                 <telerik:GridBoundColumn HeaderStyle-Width="2%" HeaderText="Total Holding value" DataField="totalNAV"
                ...
                <telerik:GridCalculatedColumn DataFields="Rec_Expectedamount,ACSR_ReducedValue,ACSR_ServiceTaxValue"
                    Expression="({0})-({0}*{1}/100)-({0}*{2}/100)" SortExpression="RecborkageExpectedvalue" UniqueName="RecborkageExpectedvalue" HeaderText="Receivable Net Commission"
                ...
                <telerik:GridBoundColumn HeaderStyle-Width="2%" HeaderText=" Payable Rate unit"
                ...
                <telerik:GridBoundColumn HeaderStyle-Width="2%" HeaderText="Amount Difference"
    ...
    <telerik:RadGrid ID="rgNCDIPOMIS" runat="server" GridLines="None" AutoGenerateColumns="False"
        ...
        <MasterTableView Width="180%" AllowMultiColumnSorting="True" AutoGenerateColumns="false"
            ...
            <Columns>
                ...
                <telerik:GridBoundColumn HeaderStyle-Width="10%" HeaderText="Receivable"
                    DataField="Rec_brokeragevalue" HeaderStyle-HorizontalAlign="Right" UniqueName="Rec_brokeragevalue"
                    SortExpression="Rec_brokeragevalue" AutoPostBackOnFilter="true" AllowFiltering="false"
                    ShowFilterIcon="false" CurrentFilterFunction="Contains" FooterStyle-HorizontalAlign="Right"
                    Aggregate="Sum" Visible="false">
                    <ItemStyle Width="" HorizontalAlign="Right" Wrap="false" VerticalAlign="Top" />
                </telerik:GridBoundColumn>
                ...
                <telerik:GridBoundColumn HeaderStyle-Width="10%" HeaderText="Payable"
