              ...
              <tr>
                ...
                <tr id="trFrequency" runat="server" style="display:none">
                    ...
                    <td class="rightField">
                        ...
                        <asp:ListItem Text="Once In Two Year" Value="OnceInTwoYear">                                              
                        </asp:ListItem>                        
                        </asp:DropDownList>
                ...
                <td>
                 <asp:Button ID="btnNonRTSave" runat="server" CssClass="PCGMediumButton" 
                            Text="Save" ValidationGroup="btnSave" onclick="btnNonRTSave_Click"  />
                </td>
                </tr>
    ...
    <tr>
                ...
                <td>
                 <asp:Button ID="btnRTSave" runat="server" CssClass="PCGButton" 
                            Text="Save" ValidationGroup="btnRTSave"  />
                </td>
                </tr>
</table>
</asp:Panel>
