<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ViewFPUtilityUserDetails.ascx.cs" Inherits="WealthERP.FP.ViewFPUtilityUserDetails" %>
    ...
    <tr>
        <td>
            <telerik:RadGrid ID="gvLeadList" runat="server" AllowAutomaticDeletes="false" PageSize="10"
              ...
              Visible="false">
                <MasterTableView Width="80%" DataKeyNames="FPUUD_UserId" AllowMultiColumnSorting="True"
