...
<script type="text/javascript">
    function Total() {
        ...
        var AllLISurrenderMrktTotal = 0.0;
        ...
        if (document.getElementById("<%=txtEducationExpense.ClientID%>").value != "") {
            expensetotal += parseFloat(document.getElementById("<%=txtEducationExpense.ClientID%>").value);
        }
        //Liabilities
        ...
        if (document.getElementById("<%=txtVehicleInsuranceSA.ClientID%>").value != "") {
            generalInsuranceTotal += parseFloat(document.getElementById("<%=txtVehicleInsuranceSA.ClientID%>").value);
        }
        ...
        if (document.getElementById("<%=txtTotalVehicleInsurancePremium.ClientID%>").value != "") {
            AllLIandGIPremiumTotal += parseFloat(document.getElementById("<%=txtTotalVehicleInsurancePremium.ClientID%>").value);
        }
        ...
        //Life Insurance SurrenderValueTotal
        ////        if (document.getElementById("<%=txtTotalSurrMrktValue.ClientID%>").value != "") {
        ////            AllLISurrenderMrktTotal += parseFloat(document.getElementById("<%=txtTotalSurrMrktValue.ClientID%>").value);
        ////        }
        ////        if (document.getElementById("<%=txtTotalEndowmentSurrMktVal.ClientID%>").value != "") {
        ////            AllLISurrenderMrktTotal += parseFloat(document.getElementById("<%=txtTotalEndowmentSurrMktVal.ClientID%>").value);
        ////        }
        ////        if (document.getElementById("<%=txtTotalWholeLifeSurrMrktVal.ClientID%>").value != "") {
        ////            AllLISurrenderMrktTotal += parseFloat(document.getElementById("<%=txtTotalWholeLifeSurrMrktVal.ClientID%>").value);
        ////        }
        ////        if (document.getElementById("<%=txtTotalMoneyBackSurrenMarkt.ClientID%>").value != "") {
        ////            AllLISurrenderMrktTotal += parseFloat(document.getElementById("<%=txtTotalMoneyBackSurrenMarkt.ClientID%>").value);
        ////        }
        ////        if (document.getElementById("<%=txtTotalULIPSurrMrktVal.ClientID%>").value != "") {
        ////            AllLISurrenderMrktTotal += parseFloat(document.getElementById("<%=txtTotalULIPSurrMrktVal.ClientID%>").value);
        ////        }
        ////        if (document.getElementById("<%=txtTotalOthersSurrenMrktval.ClientID%>").value != "") {
        ////            AllLISurrenderMrktTotal += parseFloat(document.getElementById("<%=txtTotalOthersSurrenMrktval.ClientID%>").value);
        ////        }   
        ...
        <tr>
            <td>
                ...
                <telerik:RadTabStrip ID="RadTabStrip1" runat="server" EnableTheming="True" Skin="Telerik"
                    EnableEmbeddedSkins="False" MultiPageID="CustomerProspectMultiPage" SelectedIndex="0"
            ...
            Value="Summary" ToolTip="Summery" Selected="True"> 
                        ...
                        <telerik:RadTab runat="server" onclick="HideStatusMsg()" ImageUrl="/Images/Telerik/FP/Investment.gif"
                            Text="Investment" Value="Investment" Selected="true" TabIndex="0">
                        </telerik:RadTab>
                        <telerik:RadTab runat="server" onclick="HideStatusMsg()" ImageUrl="/Images/Telerik/FP/Income.gif"
                            Text="Income" Value="Income" TabIndex="1">
                        </telerik:RadTab>
                        <telerik:RadTab runat="server" onclick="HideStatusMsg()" ImageUrl="/Images/Telerik/FP/Expense.gif"
                            Text="Expense" Value="Expense" TabIndex="2">
                        </telerik:RadTab>
                        <telerik:RadTab runat="server" onclick="HideStatusMsg()" ImageUrl="/Images/Telerik/FP/Liabilities.gif"
                            Text="Liabilities" Value="Liabilities" TabIndex="3">
                        </telerik:RadTab>
                        <telerik:RadTab runat="server" onclick="HideStatusMsg()" ImageUrl="/Images/Telerik/FP/LifeInsurance.gif"
                            Text="Life Insurance" Value="LifeInsurance" TabIndex="4">
                        </telerik:RadTab>
                ...
                <telerik:RadInputManager ID="RadInputManager1" runat="server" Skin="Telerik" EnableEmbeddedSkins="False">
                    ...
                    <telerik:NumericTextBoxSetting DecimalDigits="2" DecimalSeparator="." ErrorMessage="Numbers"
                        ...
                        <targetcontrols>
                            ...
                            <telerik:TargetInput ControlID="txtEducationExpense" />
                            ...
                            <telerik:TargetInput ControlID="txtAdjustedTermSurrenderValue" />
                            <telerik:TargetInput ControlID="txtAdjustedSurrMktVal" />
                            <telerik:TargetInput ControlID="txtAdjustedWholeLifeSurrMrktVal" />
                            <telerik:TargetInput ControlID="txtAdjustedMBSurrMrktValue" />
                            <telerik:TargetInput ControlID="txtAdjustedULIPSurrMrktValue" />
                            <telerik:TargetInput ControlID="txtAdjustedOthersSurrMrktVal" />
                            <telerik:TargetInput ControlID="txtWERPTermSA" />
                            <telerik:TargetInput ControlID="txtTotalTermSA" />
                            <telerik:TargetInput ControlID="txtTotalSurrMrktValue" />
                            <telerik:TargetInput ControlID="txtWERPEndowmentSA" />
                            <telerik:TargetInput ControlID="txtTotalEndowmentSA" />
                            <telerik:TargetInput ControlID="txtTotalEndowmentSurrMktVal" />
                            <telerik:TargetInput ControlID="txtWERPWholeLifeSA" />
                            <telerik:TargetInput ControlID="txtTotalWholeLifeSA" />
                            <telerik:TargetInput ControlID="txtTotalWholeLifeSurrMrktVal" />
                            <telerik:TargetInput ControlID="txtWERPMoneyBackSA" />
                            <telerik:TargetInput ControlID="txtTotalMoneyBackSA" />
                            <telerik:TargetInput ControlID="txtTotalMoneyBackSurrenMarkt" />
                            <telerik:TargetInput ControlID="txtWERPULIPSA" />
                            <telerik:TargetInput ControlID="txtTotalULIPSA" />
                            <telerik:TargetInput ControlID="txtTotalULIPSurrMrktVal" />
                            <telerik:TargetInput ControlID="txtTotalOthersLISA" />
                            <telerik:TargetInput ControlID="txtWERPOthersLISA" />
                            <telerik:TargetInput ControlID="txtTotalOthersSurrenMrktval" />
                            ...
                            <telerik:TargetInput ControlID="txtVehicleInsuranceSA" />
                            <telerik:TargetInput ControlID="txtPropertyInsuranceCoverSA" />
                            <telerik:TargetInput ControlID="txtHealthInsuranceCoverSA" />
                            <telerik:TargetInput ControlID="lblTotalSumAssuredGI" />
                             <telerik:TargetInput ControlID="txtOthersGISA" />
                            
                            
                             <telerik:TargetInput ControlID="txtVehicleInsuranceP" />
                            <telerik:TargetInput ControlID="txtVehicleInsuranceA" />
                            <telerik:TargetInput ControlID="txtVehicleInsurancePremium" />
                            <telerik:TargetInput ControlID="txtTotalVehicleInsurancePremium" />
                            ...
                            <%-- Added new EMI Adjustment and Total Text boxes for liabilities --%>
                            <telerik:TargetInput ControlID="txtHomeLoanEMIA" />
                            <telerik:TargetInput ControlID="txtHomeLoanEMITotal" />
                            <telerik:TargetInput ControlID="txtAutoLoanEMIA" />
                            <telerik:TargetInput ControlID="txtAutoLoanEMITotal" />
                            <telerik:TargetInput ControlID="txtPersonalLoanEMIA" />
                            <telerik:TargetInput ControlID="txtPersonalLoanEMITotal" />
                            <telerik:TargetInput ControlID="txtEducationLoanEMIA" />
                            <telerik:TargetInput ControlID="txtEducationLoanEMITotal" />
                            <telerik:TargetInput ControlID="txtOtherLoanEMIA" />
                            <telerik:TargetInput ControlID="txtOtherLoanEMITotal" />
                        </targetcontrols>
                ...
                <telerik:RadMultiPage ID="CustomerProspectMultiPage" EnableViewState="true" runat="server"
                    SelectedIndex="0">
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="left" colspan="2">
                                                        <asp:TextBox ID="txtAssetTotal" runat="server" Style="direction: rtl" Enabled="false"
                                                            Width="175px" EnableViewState="true"></asp:TextBox>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td align="right">
                                    ...
                                    <td>
                                        <table width="60%">
                                            ...
                                            <tr>
                                                ...
                                                <td align="left">
                                                    <asp:TextBox ID="txtSlabProfile" runat="server" onblur="fillValueToPopup();" Style="direction: rtl"
                                                        Enabled="false" EnableViewState="true"></asp:TextBox>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="right">
                                   ...
                                   OnClientClick="return CallFunOnCalculation()" 
                                        onclick="btnSlabGettingCalculator_Click">Disposable Income Calculator</asp:LinkButton>
                                            ...
                                            <tr>
                                                ...
                                                <td align="left">
                                                    <asp:TextBox ID="txtIncomeTotal" runat="server" Style="direction: rtl" EnableViewState="true"></asp:TextBox>
                                                </td>
                                            </tr>
                                            <tr id="Tr1" runat="server" visible="false">
                                                ...
                                                <td align="left">
                                                    <cc1:ModalPopupExtender ID="mdlPopupSlabCalculate" runat="server" PopupControlID="CalculatePopUp"
                                                        TargetControlID="hdnModalPopupId" OkControlID="btnCalculationSubmit" CancelControlID="btnCancel"
                                                        BackgroundCssClass="modalBackground" Enabled="true" Drag="true">
                                                    </cc1:ModalPopupExtender>
                                                </td>
                                                <td>
                                                    <asp:Panel ID="CalculatePopUp" onclick="MainCalculate()" Width="300px" CssClass="ModelPup"
                                                        runat="server">
                                                        <table>
                                                            <tr>
                                                                <td>
                                                                ...
                                                                <td align="left">
                                                                    <asp:TextBox ID="txtTaxableIncome" runat="server" onblur="MainCalculate()" onchange="CallFuncOnTxtTaxableIncome()"
                                                                        Style="direction: rtl"></asp:TextBox>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td>
                                                                    <asp:Label ID="lbltxtSlabAsPerProfile" runat="server" Text="As per your profile your tax slab is"
                                                                        CssClass="FieldName"></asp:Label>
                                                                </td>
                                                                <td align="left">
                                                                    <asp:TextBox ID="txtSlabAsPerProfile" runat="server" ReadOnly="false" Enabled="false"
                                                                        Style="direction: rtl"></asp:TextBox>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <asp:Label ID="lblIncomePreTax" runat="server" Text="Disposable income (pre tax)"
                                                                        CssClass="FieldName"></asp:Label>
                                                                </td>
                                                                <td align="left">
                                                                    <asp:TextBox ID="txtIncomePreTax" runat="server" onfocus="CallFunOnTxtIncomePreTax()"
                                                                        Style="direction: rtl"></asp:TextBox>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td>
                                                                    <asp:Label ID="lblIncomePostTax" runat="server" Text="Disposable income (post tax)"
                                                                        CssClass="FieldName"></asp:Label>
                                                                </td>
                                                                <td align="left">
                                                                    <asp:TextBox ID="txtIncomePostTax" ReadOnly="false" onfocus="CallFunOnTxtIncomePostTax()"
                                                                        runat="server" Style="direction: rtl"></asp:TextBox>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td>
                                                                    <asp:Button ID="btnCalculationSubmit" runat="server" Text="Submit" CssClass="PCGButton"
                                                                        OnClientClick="SubmitButtonFun()" OnClick="btnCalculationSubmit_Click" />
                                                                </td>
                                                                <td>
                                                                    <asp:Button ID="btnCancel" runat="server" OnClientClick="ClearTaxslabfields()" Text="Cancel"
                                                                        CssClass="PCGButton" />
                                                                </td>
                                                            </tr>
                                                            <tr>
                                            ...
                                            <tr id="Tr2" runat="server" visible="false">
                                                <td colspan="5">
                                                    <span style="font-size: small" class="cmbField">Notes: 1.If you have entered the pretax
                                                        income then you can calculate the disposal
                                                        <br />
                                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;income
                                                        using Disposal income Calculator.
                                                        <br />
                                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;2.Taxslab can be edited
                                                        from the profile </span>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                                    ...
                                    <td>
                                        <table width="60%">
                                            ...
                                            <tr>
                                                ...
                                                <td align="left">
                                                    <asp:TextBox ID="txtInsurance" ReadOnly="false" Enabled="false" runat="server" Style="direction: rtl"></asp:TextBox>
                                                </td>
                                                <%--  <td align="right">
                                ...
                                <td align="left">
                                    <asp:TextBox ID="txtDomesticHelp" runat="server" Style="direction: rtl" onchange="Total()"></asp:TextBox>
                                            ...
                                            <tr>
                                                ...
                                                <td align="left">
                                                    <asp:TextBox ID="txtMFSIPMIS" runat="server" ReadOnly="false" Enabled="false" Style="direction: rtl"
                                                        onchange="Total()"></asp:TextBox>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td align="left">
                                                    <asp:TextBox ID="txtReccuringDeposit" runat="server" ReadOnly="false" Enabled="false"
                                                        Style="direction: rtl" onchange="Total()"></asp:TextBox>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="right">
                                                ...
                                                <td align="right">
                                                    <asp:Label ID="lblExpenseEMI" runat="server" Text="Loan EMI : " CssClass="FieldName"></asp:Label>
                                                </td>
                                                <td align="left">
                                                    <asp:TextBox ID="txtExpenseEMI" runat="server" ReadOnly="false" Enabled="false" Style="direction: rtl"></asp:TextBox>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="right">
                               ...
                               <td align="left">
                                    <asp:TextBox ID="txtInsurance" ReadOnly="false" Enabled="false" runat="server" 
                                        Style="direction: rtl" ></asp:TextBox>
                                                ...
                                                <td align="right">
                                                    <asp:Label ID="lblEducationExpense" runat="server" Text="Education : " CssClass="FieldName"></asp:Label>
                                                </td>
                                                <td align="left">
                                                    <asp:TextBox ID="txtEducationExpense" runat="server" Style="direction: rtl" onchange="Total()"></asp:TextBox>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                ...
                                                <td align="right">
                                                    <asp:Label ID="lblExpenseTotal" runat="server" Text="Grand Total :  " CssClass="FieldName"></asp:Label>
                                                </td>
                                                <td align="left">
                                        ...
                                        <table width="100%">
                                            <tr>
                                                ...
                                                <td colspan="2" align="center" style="border-bottom: 1px solid gray;">
                                                    <asp:Label ID="Label2" runat="server" CssClass="FieldName" Font-Bold="true" Font-Underline="False"
                                                        Font-Size="11px" Text="Portfolio"></asp:Label>
                                                </td>
                                                <td colspan="2" align="center" style="border-bottom: 1px solid gray;">
                                                    <asp:Label ID="Label3" Font-Size="11px" runat="server" CssClass="FieldName" Font-Bold="true"
                                                        Font-Underline="False" Text="Adjustments"></asp:Label>
                                                </td>
                                                <td colspan="2" align="center" style="border-bottom: 1px solid gray;">
                                                    <asp:Label ID="Label4" runat="server" CssClass="FieldName" Font-Bold="true" Font-Underline="False"
                                                        Font-Size="11px" Text="Total"></asp:Label>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                ...
                                                <td align="center">
                                                    <asp:Label ID="lblLoanOutstandingPortfolio" runat="server" CssClass="FieldName" Text="OutStanding Amount"></asp:Label>
                                                </td>
                                                <td align="center">
                                                    <asp:Label ID="lblEMIPortfolio" runat="server" CssClass="FieldName" Text="EMI (Annual)"></asp:Label>
                                                </td>
                                                <td align="center">
                                                    <asp:Label ID="lblLoanOutstandingAdjustment" runat="server" CssClass="FieldName"
                                                        Text="OutStanding Amount"></asp:Label>
                                                </td>
                                                <td align="center">
                                                    <asp:Label ID="lblEMIAdjustment" runat="server" CssClass="FieldName" Text="EMI (Annual)"></asp:Label>
                                                </td>
                                                <td align="center">
                                                    <asp:Label ID="lblLoanOutStandingTotal" runat="server" CssClass="FieldName" Text="Loan OutStanding Amount"></asp:Label>
                                                </td>
                                                <td align="center">
                                                    <asp:Label ID="lblEMITotal" runat="server" CssClass="FieldName" Text="EMI (Annual)"></asp:Label>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="right">
                                                    <asp:Label ID="lblHomeLoan" runat="server" CssClass="FieldName" Text="Home Loan : "></asp:Label>
                                                </td>
                                                <td align="left">
                                                    <asp:TextBox ID="txtWERPHomeLoan" runat="server" Enabled="false" Style="direction: rtl"></asp:TextBox>
                                                </td>
                                                <td align="left">
                                                    <asp:TextBox ID="txtHomeLoanEMI" runat="server" Enabled="false" Style="direction: rtl"></asp:TextBox>
                                                </td>
                                                <td align="left">
                                                    <asp:TextBox ID="txtHomeLoanA" runat="server" onchange="SubTotal('txtWERPHomeLoan','txtHomeLoanA','NULL','txtHomeLoanLO')"
                                                        Style="direction: rtl"></asp:TextBox>
                                                </td>
                                                <td align="left">
                                                    <asp:TextBox ID="txtHomeLoanEMIA" runat="server" onchange="SubTotal('txtHomeLoanEMI','txtHomeLoanEMIA','NULL','txtHomeLoanEMITotal')"
                                                        Style="direction: rtl"></asp:TextBox>
                                                </td>
                                                <td align="left">
                                                    <asp:TextBox ID="txtHomeLoanLO" runat="server" onchange="Total()" Style="direction: rtl"></asp:TextBox>
                                                </td>
                                                <td align="left">
                                                    <asp:TextBox ID="txtHomeLoanEMITotal" runat="server" onchange="Total()" Style="direction: rtl"></asp:TextBox>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="right">
                                                    <asp:Label ID="lblAutoLoan" runat="server" CssClass="FieldName" Text="Auto Loan : "></asp:Label>
                                                </td>
                                                <td align="left">
                                                    <asp:TextBox ID="txtWERPAutoLoan" runat="server" Enabled="false" Style="direction: rtl"></asp:TextBox>
                                                </td>
                                                <td align="left">
                                                    <asp:TextBox ID="txtAutoLoanEMI" runat="server" Enabled="false" Style="direction: rtl"></asp:TextBox>
                                                </td>
                                                <td align="left">
                                                    <asp:TextBox ID="txtAutoLoanA" runat="server" onchange="SubTotal('txtWERPAutoLoan','txtAutoLoanA','NULL','txtAutoLoanLO')"
                                                        Style="direction: rtl"></asp:TextBox>
                                                </td>
                                                <td align="left">
                                                    <asp:TextBox ID="txtAutoLoanEMIA" runat="server" onchange="SubTotal('txtAutoLoanEMI','txtAutoLoanEMIA','NULL','txtAutoLoanEMITotal')"
                                                        Style="direction: rtl"></asp:TextBox>
                                                </td>
                                                <td align="left">
                                                    <asp:TextBox ID="txtAutoLoanLO" runat="server" onchange="Total()" Style="direction: rtl"></asp:TextBox>
                                                </td>
                                                <td align="left">
                                                    <asp:TextBox ID="txtAutoLoanEMITotal" runat="server" onchange="Total()" Style="direction: rtl"></asp:TextBox>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="right">
                                                    <asp:Label ID="lblPersonalLoan" runat="server" CssClass="FieldName" Text="Personal Loan : "></asp:Label>
                                                </td>
                                                <td align="left">
                                                    <asp:TextBox ID="txtWERPPersonalLoan" runat="server" Enabled="false" Style="direction: rtl"></asp:TextBox>
                                                </td>
                                                <td align="left">
                                                    <asp:TextBox ID="txtPersonalLoanEMI" runat="server" Enabled="false" Style="direction: rtl"></asp:TextBox>
                                                </td>
                                                <td align="left">
                                                    <asp:TextBox ID="txtPersonalLoanA" runat="server" onchange="SubTotal('txtWERPPersonalLoan','txtPersonalLoanA','NULL','txtPersonalLoanLO')"
                                                        Style="direction: rtl"></asp:TextBox>
                                                </td>
                                                <td align="left">
                                                    <asp:TextBox ID="txtPersonalLoanEMIA" runat="server" onchange="SubTotal('txtPersonalLoanEMI','txtPersonalLoanEMIA','NULL','txtPersonalLoanEMITotal')"
                                                        Style="direction: rtl"></asp:TextBox>
                                                </td>
                                                <td align="left">
                                                    <asp:TextBox ID="txtPersonalLoanLO" runat="server" onchange="Total()" Style="direction: rtl"></asp:TextBox>
                                                </td>
                                                <td align="left">
                                                    <asp:TextBox ID="txtPersonalLoanEMITotal" runat="server" onchange="Total()" Style="direction: rtl"></asp:TextBox>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="right">
                                                    <asp:Label ID="lblEducationLoan" runat="server" CssClass="FieldName" Text="Education Loan : "></asp:Label>
                                                </td>
                                                <td align="left">
                                                    <asp:TextBox ID="txtWERPEducationLoan" runat="server" Enabled="false" Style="direction: rtl"></asp:TextBox>
                                                </td>
                                                <td align="left">
                                                    <asp:TextBox ID="txtEducationLoanEMI" runat="server" Enabled="false" Style="direction: rtl"></asp:TextBox>
                                                </td>
                                                <td align="left">
                                                    <asp:TextBox ID="txtEducationLoanA" runat="server" onchange="SubTotal('txtWERPEducationLoan','txtEducationLoanA','NULL','txtEducationLoanLO')"
                                                        Style="direction: rtl"></asp:TextBox>
                                                </td>
                                                <td align="left">
                                                    <asp:TextBox ID="txtEducationLoanEMIA" runat="server" onchange="SubTotal('txtEducationLoanEMI','txtEducationLoanEMIA','NULL','txtEducationLoanEMITotal')"
                                                        Style="direction: rtl"></asp:TextBox>
                                                </td>
                                                <td align="left">
                                                    <asp:TextBox ID="txtEducationLoanLO" runat="server" onchange="Total()" Style="direction: rtl"></asp:TextBox>
                                                </td>
                                                <td align="left">
                                                    <asp:TextBox ID="txtEducationLoanEMITotal" runat="server" onchange="Total()" Style="direction: rtl"></asp:TextBox>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="right">
                                                    <asp:Label ID="lblOtherLoan" runat="server" CssClass="FieldName" Text="Others : "></asp:Label>
                                                </td>
                                                <td align="left">
                                                    <asp:TextBox ID="txtWERPOtherLoan" runat="server" Enabled="false" Style="direction: rtl"></asp:TextBox>
                                                </td>
                                                <td align="left">
                                                    <asp:TextBox ID="txtOtherLoanEMI" runat="server" Enabled="false" Style="direction: rtl"></asp:TextBox>
                                                </td>
                                                <td align="left">
                                                    <asp:TextBox ID="txtOtherLoanA" runat="server" onchange="SubTotal('txtWERPOtherLoan','txtOtherLoanA','NULL','txtOtherLoanLO')"
                                                        Style="direction: rtl"></asp:TextBox>
                                                </td>
                                                <td align="left">
                                                    <asp:TextBox ID="txtOtherLoanEMIA" runat="server" onchange="SubTotal('txtOtherLoanEMI','txtOtherLoanEMIA','NULL','txtOtherLoanEMITotal')"
                                                        Style="direction: rtl"></asp:TextBox>
                                                </td>
                                                <td align="left">
                                                    <asp:TextBox ID="txtOtherLoanLO" runat="server" onchange="Total()" Style="direction: rtl"></asp:TextBox>
                                                </td>
                                                <td align="left">
                                                    <asp:TextBox ID="txtOtherLoanEMITotal" runat="server" onchange="Total()" Style="direction: rtl"></asp:TextBox>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="right">
                                                ...
                                                <td align="right">
                                                    <asp:Label ID="lblTotal" runat="server" CssClass="FieldName" Text="Grand Total : "></asp:Label>
                                                </td>
                                                <td align="left">
                                                    <asp:TextBox ID="txtTotalLO" runat="server" EnableViewState="true" Style="direction: rtl"></asp:TextBox>
                                                </td>
                                                <td align="left">
                                                    <asp:TextBox ID="txtTotalEmILO" runat="server" EnableViewState="true" onchange="Total()"
                                                        Style="direction: rtl" Visible="false"></asp:TextBox>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                                    ...
                                    <td>
                                        <table width="100%">
                                            <tr>
                                                ...
                                                <td colspan="3" align="center" style="border-bottom: 1px solid gray;">
                                                    <asp:Label ID="lblLifeInsurancePortfolio" runat="server" CssClass="FieldName" Font-Bold="true"
                                                        Font-Underline="False" Font-Size="11px" Text="Portfolio"></asp:Label>
                                                </td>
                                                <td colspan="3" align="center" style="border-bottom: 1px solid gray;">
                                                ...
                                                <td colspan="3" align="center" style="border-bottom: 1px solid gray;">
                                                    <asp:Label ID="lblLifeInsuranceMainTotal" runat="server" CssClass="FieldName" Font-Bold="true"
                                                        Font-Underline="False" Font-Size="11px" Text="Total"></asp:Label>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="right">
                                                ...
                                                <td align="left">
                                                    <asp:Label ID="lblWERPSumAssuredLI" runat="server" CssClass="FieldName" Enabled="false"
                                                        Text="Sum Assured"></asp:Label>
                                                </td>
                                                <td align="left">
                                                    <asp:Label ID="lblPremiumLI" runat="server" CssClass="FieldName" Text="Premium (Annual)"></asp:Label>
                                                </td>
                                                <td align="left">
                                                    <asp:Label ID="lblSurrenderMarketValue" runat="server" CssClass="FieldName" Text="Surrender/Market Value"></asp:Label>
                                                </td>
                                                <td align="left">
                                                    <asp:Label ID="lblSumAssuredLI" runat="server" CssClass="FieldName" Text="Sum Assured"></asp:Label>
                                                </td>
                                                <td align="left">
                                                    <asp:Label ID="Label1" runat="server" CssClass="FieldName" Text="Premium (Annual)"></asp:Label>
                                                </td>
                                                <td align="left">
                                                    <asp:Label ID="lblSurrenderMarketValueAdjust" runat="server" CssClass="FieldName"
                                                        Text="Surrender/Market Value"></asp:Label>
                                                </td>
                                                <td align="left">
                                                    <asp:Label ID="lblTotalSumAssuredLI" runat="server" CssClass="FieldName" Text="Sum Assured"></asp:Label>
                                                </td>
                                                <td align="left">
                                                    <asp:Label ID="lblTotalPremium" runat="server" CssClass="FieldName" Text="Premium (Annual)"></asp:Label>
                                                </td>
                                                <td align="left">
                                                    <asp:Label ID="lblTotalSurrenderMarketValue" runat="server" CssClass="FieldName"
                                                        Text="Surrender/Market Value"></asp:Label>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="right">
                                                    <asp:Label ID="lblTerm" runat="server" CssClass="FieldName" Text="Term : "></asp:Label>
                                                </td>
                                                <td align="left">
                                                ...
                                                <td align="left">
                                                    <asp:TextBox ID="txtTermP" runat="server" Enabled="false" onchange="Total()" Style="direction: rtl"
                                                        Width="90px"></asp:TextBox>
                                                </td>
                                                <td align="left">
                                                    <asp:TextBox ID="txtTermSurrMktVal" runat="server" Style="direction: rtl" ReadOnly="true"
                                                        Width="90px"></asp:TextBox>
                                                </td>
                                                <td align="left">
                                                    <asp:TextBox ID="txtAdjustedTermSA" runat="server" onchange="SubTotal('txtWERPTermSA','txtAdjustedTermSA','NULL','txtTotalTermSA')"
                                                        Style="direction: rtl" Width="90px"></asp:TextBox>
                                                </td>
                                                <td align="left">
                                                    <asp:TextBox ID="txtAdjustedPremium" runat="server" onchange="SubTotal('txtTermP','txtAdjustedPremium','NULL','txtTotalTermPremium')"
                                                        Style="direction: rtl" Width="90px"></asp:TextBox>
                                                </td>
                                                <td align="left">
                                                    <asp:TextBox ID="txtAdjustedTermSurrenderValue" runat="server" onchange="SubTotal('txtTermSurrMktVal','txtAdjustedTermSurrenderValue','NULL','txtTotalSurrMrktValue')"
                                                        Style="direction: rtl" Width="90px"></asp:TextBox>
                                                </td>
                                                <td align="left">
                                                    <asp:TextBox ID="txtTotalTermSA" runat="server" onchange="Total()" Style="direction: rtl"
                                                        Width="90px"></asp:TextBox>
                                                </td>
                                                <td align="left">
                                                ...
                                                <td align="left">
                                                    <asp:TextBox ID="txtTotalSurrMrktValue" runat="server" onchange="Total()" Style="direction: rtl"
                                                        Width="90px"></asp:TextBox>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="right">
                                                    <asp:Label ID="lblEndowment" runat="server" CssClass="FieldName" Text="Endowment : "></asp:Label>
                                                </td>
                                                <td align="left">
                                                ...
                                                <td align="left">
                                                    <asp:TextBox ID="txtEndowmentSurrMktVal" runat="server" Style="direction: rtl" Width="90px"
                                                        ReadOnly="true"></asp:TextBox>
                                                </td>
                                                <td align="left">
                                                    <asp:TextBox ID="txtAdjustedEndowmentSA" runat="server" onchange="SubTotal('txtWERPEndowmentSA','txtAdjustedEndowmentSA','NULL','txtTotalEndowmentSA')"
                                                        Style="direction: rtl" Width="90px"></asp:TextBox>
                                                </td>
                                                <td align="left">
                                                    <asp:TextBox ID="txtAdjustedEndowmentPremium" runat="server" onchange="SubTotal('txtEndowmentP','txtAdjustedEndowmentPremium','NULL','txtTotalEndowmentPremium')"
                                                        Style="direction: rtl" Width="90px"></asp:TextBox>
                                                </td>
                                                <td align="left">
                                                    <asp:TextBox ID="txtAdjustedSurrMktVal" runat="server" onchange="SubTotal('txtEndowmentSurrMktVal','txtAdjustedSurrMktVal','NULL','txtTotalEndowmentSurrMktVal')"
                                                        Style="direction: rtl" Width="90px"></asp:TextBox>
                                                </td>
                                                <td align="left">
                                                    <asp:TextBox ID="txtTotalEndowmentSA" runat="server" onchange="Total()" Style="direction: rtl"
                                                        Width="90px"></asp:TextBox>
                                                </td>
                                                <td align="left">
                                                    <asp:TextBox ID="txtTotalEndowmentPremium" runat="server" onchange="Total()" ReadOnly="false"
                                                        Style="direction: rtl" Width="90px"></asp:TextBox>
                                                </td>
                                                <td align="left">
                                                    <asp:TextBox ID="txtTotalEndowmentSurrMktVal" runat="server" onchange="Total()" Style="direction: rtl"
                                                        Width="90px"></asp:TextBox>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="right">
                                                    <asp:Label ID="lblWholeLife" runat="server" CssClass="FieldName" Text="Whole Life : "></asp:Label>
                                                </td>
                                                <td align="left">
                                                ...
                                                <td align="left">
                                                    <asp:TextBox ID="txtWholeLifeSurrMktVal" runat="server" Style="direction: rtl" Width="90px"
                                                        ReadOnly="true"></asp:TextBox>
                                                </td>
                                                <td align="left">
                                                    <asp:TextBox ID="txtAdjustedWholeLifeSA" runat="server" onchange="SubTotal('txtWERPWholeLifeSA','txtAdjustedWholeLifeSA','NULL','txtTotalWholeLifeSA')"
                                                        Style="direction: rtl" Width="90px"></asp:TextBox>
                                                </td>
                                                <td align="left">
                                                    <asp:TextBox ID="txtAdjustedWholeLifePremium" runat="server" onchange="SubTotal('txtWholeLifeP','txtAdjustedWholeLifePremium','NULL','txtTotalWholeLifePremium')"
                                                        Style="direction: rtl" Width="90px"></asp:TextBox>
                                                </td>
                                                <td align="left">
                                                    <asp:TextBox ID="txtAdjustedWholeLifeSurrMrktVal" runat="server" onchange="SubTotal('txtWholeLifeSurrMktVal','txtAdjustedWholeLifeSurrMrktVal','NULL','txtTotalWholeLifeSurrMrktVal')"
                                                        Style="direction: rtl" Width="90px"></asp:TextBox>
                                                </td>
                                                <td align="left">
                                                    <asp:TextBox ID="txtTotalWholeLifeSA" runat="server" onchange="Total()" Style="direction: rtl"
                                                        Width="90px"></asp:TextBox>
                                                </td>
                                                <td align="left">
                                                    <asp:TextBox ID="txtTotalWholeLifePremium" runat="server" onchange="Total()" ReadOnly="false"
                                                        Style="direction: rtl" Width="90px"></asp:TextBox>
                                                </td>
                                                <td align="left">
                                                    <asp:TextBox ID="txtTotalWholeLifeSurrMrktVal" runat="server" onchange="Total()"
                                                        Style="direction: rtl" Width="90px"></asp:TextBox>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="right">
                                                    <asp:Label ID="lblMoneyBack" runat="server" CssClass="FieldName" Text="Money Back : "></asp:Label>
                                                </td>
                                                <td align="left">
                                                    <asp:TextBox ID="txtWERPMoneyBackSA" runat="server" Enabled="false" Style="direction: rtl"
                                                        Width="90px"></asp:TextBox>
                                                </td>
                                                <td align="left">
                                                ...
                                                <td align="left">
                                                    <asp:TextBox ID="txtMoneyBackSurrMktVal" runat="server" Style="direction: rtl" Width="90px"
                                                        ReadOnly="true"></asp:TextBox>
                                                </td>
                                                <td align="left">
                                                    <asp:TextBox ID="txtAdjustedMoneyBackSA" runat="server" onchange="SubTotal('txtWERPMoneyBackSA','txtAdjustedMoneyBackSA','NULL','txtTotalMoneyBackSA')"
                                                        Style="direction: rtl" Width="90px"></asp:TextBox>
                                                </td>
                                                <td align="left">
                                                    <asp:TextBox ID="txtAdjustedMoneyBackPremium" runat="server" onchange="SubTotal('txtMoneyBackP','txtAdjustedMoneyBackPremium','NULL','txtTotalMoneyBackPremium')"
                                                        Style="direction: rtl" Width="90px"></asp:TextBox>
                                                </td>
                                                <td align="left">
                                                    <asp:TextBox ID="txtAdjustedMBSurrMrktValue" runat="server" onchange="SubTotal('txtMoneyBackSurrMktVal','txtAdjustedMBSurrMrktValue','NULL','txtTotalMoneyBackSurrenMarkt')"
                                                        Style="direction: rtl" Width="90px"></asp:TextBox>
                                                </td>
                                                <td align="left">
                                                    <asp:TextBox ID="txtTotalMoneyBackSA" runat="server" onchange="Total()" Style="direction: rtl"
                                                        Width="90px"></asp:TextBox>
                                                </td>
                                                <td align="left">
                                                    <asp:TextBox ID="txtTotalMoneyBackPremium" runat="server" onchange="Total()" ReadOnly="false"
                                                        Style="direction: rtl" Width="90px"></asp:TextBox>
                                                </td>
                                                <td align="left">
                                                    <asp:TextBox ID="txtTotalMoneyBackSurrenMarkt" runat="server" onchange="Total()"
                                                        Style="direction: rtl" Width="90px"></asp:TextBox>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="right">
                                                    <asp:Label ID="lblULIP" runat="server" CssClass="FieldName" Text="ULIP : "></asp:Label>
                                                </td>
                                                <td align="left">
                                                ...
                                                <td align="left">
                                                    <asp:TextBox ID="txtULIPP" runat="server" Enabled="false" onchange="Total()" Style="direction: rtl"
                                                        Width="90px"></asp:TextBox>
                                                </td>
                                                <td align="left">
                                                    <asp:TextBox ID="txtULIPSurrMktVal" runat="server" Style="direction: rtl" ReadOnly="true"
                                                        Width="90px"></asp:TextBox>
                                                </td>
                                                <td align="left">
                                                    <asp:TextBox ID="txtAdjustedULIPSA" runat="server" onchange="SubTotal('txtWERPULIPSA','txtAdjustedULIPSA','NULL','txtTotalULIPSA')"
                                                        Style="direction: rtl" Width="90px"></asp:TextBox>
                                                </td>
                                                <td align="left">
                                                    <asp:TextBox ID="txtAdjustedULIPPremium" runat="server" Height="22px" onchange="SubTotal('txtULIPP','txtAdjustedULIPPremium','NULL','txtTotalULIPPremium')"
                                                        Style="direction: rtl" Width="90px"></asp:TextBox>
                                                </td>
                                                <td align="left">
                                                    <asp:TextBox ID="txtAdjustedULIPSurrMrktValue" runat="server" Height="22px" onchange="SubTotal('txtULIPSurrMktVal','txtAdjustedULIPSurrMrktValue','NULL','txtTotalULIPSurrMrktVal')"
                                                        Style="direction: rtl" Width="90px"></asp:TextBox>
                                                </td>
                                                <td align="left">
                                                    <asp:TextBox ID="txtTotalULIPSA" runat="server" onchange="Total()" Style="direction: rtl"
                                                        Width="90px"></asp:TextBox>
                                                </td>
                                                <td align="left">
                                                ...
                                                <td align="left">
                                                    <asp:TextBox ID="txtTotalULIPSurrMrktVal" runat="server" onchange="Total()" Style="direction: rtl"
                                                        Width="90px"></asp:TextBox>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="right">
                                                    <asp:Label ID="lblOthersLI" runat="server" CssClass="FieldName" Text="Others : "></asp:Label>
                                                </td>
                                                <td align="left">
                                                ...
                                                <td align="left">
                                                    <asp:TextBox ID="txtOtherSurrMktVal" runat="server" Style="direction: rtl" ReadOnly="true"
                                                        Width="90px"></asp:TextBox>
                                                </td>
                                                <td align="left">
                                                    <asp:TextBox ID="txtAdjustedOthersLISA" runat="server" onchange="SubTotal('txtWERPOthersLISA','txtAdjustedOthersLISA','NULL','txtTotalOthersLISA')"
                                                        Style="direction: rtl" Width="90px"></asp:TextBox>
                                                </td>
                                                <td align="left">
                                                    <asp:TextBox ID="txtAdjustedOthersLIPremium" runat="server" onchange="SubTotal('txtOthersLIP','txtAdjustedOthersLIPremium','NULL','txtTotalOthersPremium')"
                                                        Style="direction: rtl" Width="90px"></asp:TextBox>
                                                </td>
                                                <td align="left">
                                                    <asp:TextBox ID="txtAdjustedOthersSurrMrktVal" runat="server" onchange="SubTotal('txtOtherSurrMktVal','txtAdjustedOthersSurrMrktVal','NULL','txtTotalOthersSurrenMrktval')"
                                                        Style="direction: rtl" Width="90px"></asp:TextBox>
                                                </td>
                                                <td align="left">
                                                    <asp:TextBox ID="txtTotalOthersLISA" runat="server" onchange="Total()" Style="direction: rtl"
                                                        Width="90px"></asp:TextBox>
                                                </td>
                                                <td align="left">
                                                    <asp:TextBox ID="txtTotalOthersPremium" runat="server" onchange="Total()" ReadOnly="false"
                                                        Style="direction: rtl" Width="90px"></asp:TextBox>
                                                </td>
                                                <td align="left">
                                                    <asp:TextBox ID="txtTotalOthersSurrenMrktval" runat="server" onchange="Total()" ReadOnly="true"
                                                        Style="direction: rtl" Width="90px"></asp:TextBox>
                                                </td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td align="right">
                                                    <asp:Label ID="lblTotalLI" runat="server" CssClass="FieldName" Text="Grand Total : "></asp:Label>
                                                </td>
                                                <td align="left">
                    ...
                    <td>--%>
                            <table width="100%">
                                <tr>
                                    ...
                                    <td colspan="2" align="center" style="border-bottom: 1px solid gray;">
                                        <asp:Label ID="lblGIPortFolio" runat="server" CssClass="FieldName" Font-Size="11px"
                                            Font-Bold="true" Font-Underline="false" Text="Portfolio"></asp:Label>
                                    </td>
                                    <td colspan="2" align="center" style="border-bottom: 1px solid gray;">
                                    ...
                                    <td colspan="2" align="center" style="border-bottom: 1px solid gray;">
                                        <asp:Label ID="lblGITotalValues" runat="server" Font-Size="11px" CssClass="FieldName"
                                            Font-Bold="true" Font-Underline="false" Text="Total"></asp:Label>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="right">
                                    ...
                                    <td align="center">
                                        <asp:Label ID="lblWERPSumAssuredGI" runat="server" CssClass="FieldName" Text="Sum Assured"></asp:Label>
                                    </td>
                                    <td align="center">
                                        <asp:Label ID="lblPremiumGI" runat="server" CssClass="FieldName" Text="Premium (Annual)"></asp:Label>
                                    </td>
                                    <td align="center">
                                        <asp:Label ID="lblAdjustedSumAssuredGI" runat="server" CssClass="FieldName" Text="Sum Assured"></asp:Label>
                                    </td>
                                    <td align="center">
                                        <asp:Label ID="lblAdjustedSysPremium" runat="server" CssClass="FieldName" Text="Premium (Annual)"></asp:Label>
                                    </td>
                                    <td align="center">
                                        <asp:Label ID="lblTotalSumAssuredGI" runat="server" CssClass="FieldName" Text="Sum Assured"></asp:Label>
                                    </td>
                                    <td align="center">
                                        <asp:Label ID="lblTotalPremiumValue" runat="server" CssClass="FieldName" Text="Premium (Annual)"></asp:Label>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="right">
                                        <asp:Label ID="lblHealthInsuranceCover" runat="server" CssClass="FieldName" Text="Health Insurance Cover :"></asp:Label>
                                    </td>
                                    <td align="left">
                                        <asp:TextBox ID="txtWERPHealthInsuranceCover" runat="server" Enabled="false" Style="direction: rtl"></asp:TextBox>
                                    </td>
                                    <td align="left">
                                        <asp:TextBox ID="txtHealthInsuranceCoverP" runat="server" Enabled="false" onchange="Total()"
                                            Style="direction: rtl"></asp:TextBox>
                                    </td>
                                    <td align="left">
                                        <asp:TextBox ID="txtHealthInsuranceCoverA" runat="server" onchange="SubTotal('txtWERPHealthInsuranceCover','txtHealthInsuranceCoverA','NULL','txtHealthInsuranceCoverSA')"
                                            Style="direction: rtl"></asp:TextBox>
                                    </td>
                                    <td align="left">
                                        <asp:TextBox ID="txtAdjustedHealthPremium" runat="server" onchange="SubTotal('txtHealthInsuranceCoverP','txtAdjustedHealthPremium','NULL','txtToalHealthInsurancePremium')"
                                            Style="direction: rtl"></asp:TextBox>
                                    </td>
                                    <td align="left">
                                        <asp:TextBox ID="txtHealthInsuranceCoverSA" runat="server" onchange="Total()" Style="direction: rtl"></asp:TextBox>
                                    </td>
                                    <td align="left">
                                        <asp:TextBox ID="txtToalHealthInsurancePremium" runat="server" onchange="Total()"
                                            Style="direction: rtl"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="right">
                                        <asp:Label ID="lblPropertyInsuranceCover" runat="server" CssClass="FieldName" Text="Property Insurance Cover :"></asp:Label>
                                    </td>
                                    <td align="left">
                                        <asp:TextBox ID="txtWERPPropertyInsuranceCover" runat="server" Enabled="false" Style="direction: rtl"></asp:TextBox>
                                    </td>
                                    <td align="left">
                                        <asp:TextBox ID="txtPropertyInsuranceCoverP" runat="server" Enabled="false" onchange="Total()"
                                            Style="direction: rtl"></asp:TextBox>
                                    </td>
                                    <td align="left">
                                        <asp:TextBox ID="txtPropertyInsuranceCoverA" runat="server" onchange="SubTotal('txtWERPPropertyInsuranceCover','txtPropertyInsuranceCoverA','NULL','txtPropertyInsuranceCoverSA')"
                                            Style="direction: rtl"></asp:TextBox>
                                    </td>
                                    <td align="left">
                                        <asp:TextBox ID="txtAdjustedPropertyInsurancePremium" runat="server" onchange="SubTotal('txtPropertyInsuranceCoverP','txtAdjustedPropertyInsurancePremium','NULL','txtTotalPropertyInsurancePremium')"
                                            Style="direction: rtl"></asp:TextBox>
                                    </td>
                                    <td align="left">
                                        <asp:TextBox ID="txtPropertyInsuranceCoverSA" runat="server" onchange="Total()" Style="direction: rtl"></asp:TextBox>
                                    </td>
                                    <td align="left">
                                        <asp:TextBox ID="txtTotalPropertyInsurancePremium" runat="server" onchange="Total()"
                                            Style="direction: rtl"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="right">
                                        <asp:Label ID="lblPersonalAccident" runat="server" CssClass="FieldName" Text="Personal Accident :"></asp:Label>
                                    </td>
                                    <td align="left">
                                        <asp:TextBox ID="txtWERPPersonalAccident" runat="server" Enabled="false" Style="direction: rtl"></asp:TextBox>
                                    </td>
                                    <td align="left">
                                        <asp:TextBox ID="txtPersonalAccidentP" runat="server" Enabled="false" onchange="Total()"
                                            Style="direction: rtl"></asp:TextBox>
                                    </td>
                                    <td align="left">
                                        <asp:TextBox ID="txtPersonalAccidentA" runat="server" onchange="SubTotal('txtWERPPersonalAccident','txtPersonalAccidentA','NULL','txtPersonalAccidentSA')"
                                            Style="direction: rtl"></asp:TextBox>
                                    </td>
                                    <td align="left">
                                        <asp:TextBox ID="txtPersonalAccidentPremium" runat="server" onchange="SubTotal('txtPersonalAccidentP','txtPersonalAccidentPremium','NULL','txtTotalPersonalAccidentPremium')"
                                            Style="direction: rtl"></asp:TextBox>
                                    </td>
                                    <td align="left">
                                        <asp:TextBox ID="txtPersonalAccidentSA" runat="server" onchange="Total()" Style="direction: rtl"></asp:TextBox>
                                    </td>
                                    <td align="left">
                                        <asp:TextBox ID="txtTotalPersonalAccidentPremium" runat="server" onchange="Total()"
                                            Style="direction: rtl"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td align="left">
                                        <asp:TextBox ID="txtVehicleInsuranceP" runat="server" Enabled="false" onchange="Total()"
                                            Style="direction: rtl"></asp:TextBox>
                                    </td>
                                    <td align="left">
                                        <asp:TextBox ID="txtVehicleInsuranceA" runat="server" onchange="SubTotal('txtWERPVehicleInsurance','txtVehicleInsuranceA','NULL','txtVehicleInsuranceSA')"
                                            Style="direction: rtl"></asp:TextBox>
                                    </td>
                                    <td align="left">
                                        <asp:TextBox ID="txtVehicleInsurancePremium" runat="server" onchange="SubTotal('txtVehicleInsuranceP','txtVehicleInsurancePremium','NULL','txtTotalVehicleInsurancePremium')"
                                            Style="direction: rtl"></asp:TextBox>
                                    </td>
                                    <td align="left">
                                        <asp:TextBox ID="txtVehicleInsuranceSA" runat="server" onchange="Total()" Style="direction: rtl"></asp:TextBox>
                                    </td>
                                    <td align="left">
                                        <asp:TextBox ID="txtTotalVehicleInsurancePremium" runat="server" onchange="Total()"
                                            Style="direction: rtl"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="right">
                                        <asp:Label ID="lblOthersGI" runat="server" CssClass="FieldName" Text="Others : "></asp:Label>
                                    </td>
                                    <td align="left">
                                        <asp:TextBox ID="txtWERPOthersGI" runat="server" Enabled="false" Style="direction: rtl"></asp:TextBox>
                                    </td>
                                    <td align="left">
                                        <asp:TextBox ID="txtOthersGIP" runat="server" Enabled="false" onchange="Total()"
                                            Style="direction: rtl"></asp:TextBox>
                                    </td>
                                    <td align="left">
                                        <asp:TextBox ID="txtOthersGIA" runat="server" onchange="SubTotal('txtWERPOthersGI','txtOthersGIA','NULL','txtOthersGISA')"
                                            Style="direction: rtl"></asp:TextBox>
                                    </td>
                                    <td align="left">
                                        <asp:TextBox ID="txtAdjustedOtherGIPremium" runat="server" onchange="SubTotal('txtOthersGIP','txtAdjustedOtherGIPremium','NULL','txtTotalPremiumOthers')"
                                            Style="direction: rtl"></asp:TextBox>
                                    </td>
                                    <td align="left">
                                        <asp:TextBox ID="txtOthersGISA" runat="server" onchange="Total()" Style="direction: rtl"></asp:TextBox>
                                    </td>
                                    <td align="left">
                                        <asp:TextBox ID="txtTotalPremiumOthers" runat="server" onchange="Total()" Style="direction: rtl"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td align="Right">
                                        <asp:Label ID="lblTotalGI" runat="server" CssClass="FieldName" Text="Grand Total : "></asp:Label>
                                    </td>
                                    <td align="left">
                                        <asp:TextBox ID="txtTotalGISA" runat="server" Enabled="false" EnableViewState="true"
                                            Style="direction: rtl"></asp:TextBox>
                                    </td>
                                    <td align="left">
                                    </td>
                        ...
                        &nbsp;&nbsp;&nbsp;</telerik:RadPageView>
                </telerik:RadMultiPage><asp:Button ID="btnCustomerProspect" runat="server" OnClick="btnCustomerProspect_Click"
                    ValidationGroup="btnCustProsp" Text="Save" CssClass="PCGButton" />
            </td>
        </tr>
    </table>
</asp:Panel>
...
<asp:HiddenField ID="hdnTabSelectedIndex" runat="server" />
