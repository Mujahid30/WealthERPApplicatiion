<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="MFOrderRdemptionTransType.ascx.cs" Inherits="WealthERP.OnlineOrderManagement.MFOrderRdemptionTransType" %>
...
<table id="tbpurchase" style="height: 315px; width: 101%">
    <tr>
