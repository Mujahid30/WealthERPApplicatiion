...
<div class="row " style="margin-left: 10%; margin-top: 1%; margin-bottom: 2%; padding-top: 1%;">
    ...
    <div class="col-md-3">
         <asp:LinkButton ID="lbNFOList" runat="server" OnClick="lbNFOList_OnClick_OnClick"
            class="btn btn-primary btn-primary">NFO List<span class="glyphicon glyphicon-list-alt">
        </span></asp:LinkButton>
    </div>
    <div class="col-md-3">
    ...
    <div class="col-md-3">
         <asp:LinkButton ID="lbTopSchemes" runat="server" OnClick="lbTopSchemes_OnClick"
            class="btn btn-primary btn-primary">Top Ten Schemes<span class="glyphicon glyphicon-th-list">
        </span></asp:LinkButton>
    </div>
</div>
<asp:UpdatePanel ID="UpdatePanel1" runat="server">
    <ContentTemplate>
        <div id="dvDemo" class="row " style="margin-left: 11%; margin-top: 1%; margin-bottom: 2%;
            margin-right: 5%; padding-top: 1%; padding-bottom: 1%; background-color: #2480C7;"  visible="true">
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <%--<div class="row " style="margin-left: 2%; margin-right: 2%; margin-bottom: 2%; margin-top: 2%;
                ...
                <div class="row alignCenter" style="margin-left: 11%; margin-top: 1%; margin-bottom: 1%; padding-top: 1%; background-color: #2480C7; margin-right: 5%;" runat="server" visible="false" id="dvHeading">
                     <asp:Label ID="lblHeading" runat="server" Text="Scheme Details"   Font-Bold="true" ForeColor="White"  ></asp:Label> 
                    </div>
            ...
            <div class="row">
                <div id="no-more-tables">
                    <table class="col-md-12 table-bordered table-striped table-condensed cf" style="margin-left: 5%">
                        <thead class="cf">
                            <tr style="border-style: inset; background-color: #2480c7; font-size: small; color: White; text-align:center ">
                                ...
                                <th data-title="Return" class="alignCenter">
                                    Returns (1-yr / 3-yrs/5-yrs)
                                </th>
                                <th data-title="Buy"  class="alignCenter">
                                    Buy
                                </th>
                            <%--    <th data-title="ADDL" class="alignCenter">
                                    Addl Pur
                                </th>--%>
                                    ...
                                    <ItemTemplate>
                                        ...
                                        <td data-title="FundManager" >
                                            <asp:LinkButton ID="LinkButton1" runat="server" ToolTip="Click To view Details Information"
                                                CommandName="schemeDetails" CommandArgument='<%# Eval("PMFRD_FundManagerName")%>'> <%# Eval("PMFRD_FundManagerName")%>
                                            </asp:LinkButton>
                                        </td>
                                        <td data-title="NAV"  >
                                        ...
                                        <%--<td data-title="ADDL." >
                                            <asp:LinkButton ID="LinkButton2" runat="server" CommandArgument='<%# Eval("PASP_SchemePlanCode")%>'
                                                CommandName="Buy" CssClass="btn btn-primary btn-info" Visible='<%# Eval("IsSchemePurchege")%>'>  <span class="glyphicon glyphicon-shopping-cart">
                            </span></asp:LinkButton>
                                        </td>--%>
                                        <td data-title="SIP" >
                                        ...
                                        <td data-title="Watch" >
                                            <asp:LinkButton ID="lbViewWatch" runat="server" CommandName="viewWatchList"
                                                Visible='<% #(Convert.ToBoolean(Eval("IsInWatch"))==true) ? true : false %>'>In  <span class="glyphicon glyphicon-dashboard">
                            </span></asp:LinkButton>
                                            <asp:LinkButton ID="lbAddToWatch" runat="server"  CommandName="addToWatch"
                                                CommandArgument='<%# Eval("PASP_SchemePlanCode")%>' Visible='<% #(Convert.ToBoolean(Eval("IsInWatch"))==true) ? false :true %>'> Add To <span class="glyphicon glyphicon-dashboard">
                            </span>
                                            </asp:LinkButton>
                                        </td>
                                        </tr>
