...
<asp:UpdatePanel ID="updNCDIssue" runat="server">
    <ContentTemplate>
        <table width="100%">
            <tr>
                <td>
                                                            ...
                                                            <td colspan="100%">
                                                                <asp:Panel ID="pnlchild" runat="server" Style="display: inline" CssClass="Landscape"
                                                                    ...
                                                                    <telerik:RadGrid ID="gvChildDetails" runat="server" AutoGenerateColumns="False" enableloadondemand="True"
                                                                        ...
                                                                        OnItemDataBound="gvChildDetails_ItemDataBound">
                                                                        <MasterTableView AllowMultiColumnSorting="True" AllowSorting="true" DataKeyNames="AIM_IssueId"
                                                                            ...
                                                                            <ItemStyle HorizontalAlign="left" VerticalAlign="Top" Width="" Wrap="false" />
                                                                                ...
                                                                                <telerik:GridBoundColumn DataField="SGBFaceValue" HeaderStyle-Width="80px" HeaderText="Gold Rate"
                                                                                    CurrentFilterFunction="Contains" ShowFilterIcon="false" AutoPostBackOnFilter="true"
                                                                                    UniqueName="SGBFaceValue" DataFormatString="{0:N0}" Visible="false">
                                                                                    <ItemStyle HorizontalAlign="left" VerticalAlign="Top" Width="" Wrap="false" />
                                                                                </telerik:GridBoundColumn>
                                                                                <telerik:GridBoundColumn DataField="AID_SeriesFaceValue" HeaderStyle-Width="80px"
                                                                                    ...
                                                                                    AutoPostBackOnFilter="true" UniqueName="AID_SeriesFaceValue" DataFormatString="{0:N0}"
                                                                                    Visible="false">
                                                                                    <ItemStyle HorizontalAlign="left" VerticalAlign="Top" Width="" Wrap="false" />
                                                                                </telerik:GridBoundColumn>
                                                                            ...
                                                                            <ItemStyle HorizontalAlign="left" VerticalAlign="Top" Width="" Wrap="false" />
                                                                                ...
                                                                                <telerik:GridBoundColumn DataField="CouponRateCollection" HeaderStyle-Width="90px"
                                                                                    CurrentFilterFunction="Contains" ShowFilterIcon="false" AutoPostBackOnFilter="true"
                                                                                    HeaderText="Coupon Rate(%)" UniqueName="CouponRateCollection" SortExpression="CouponRateCollection"
                                                                                    Visible="false">
                                                                                    <ItemStyle HorizontalAlign="left" VerticalAlign="Top" Width="" Wrap="false" />
                                                                                </telerik:GridBoundColumn>
                                                                                <telerik:GridBoundColumn DataField="Interest" HeaderStyle-Width="90px" CurrentFilterFunction="Contains"
                                                                            ...
                                                                            <ItemStyle HorizontalAlign="left" VerticalAlign="Top" Width="" Wrap="false" />
                                                                                ...
                                                                                <telerik:GridBoundColumn DataField="YieldatMatCollection" HeaderStyle-Width="105px"
                                                                                    HeaderText="Yield at Maturity (%)" CurrentFilterFunction="Contains" ShowFilterIcon="false"
                                                                                    AutoPostBackOnFilter="true" SortExpression="YieldatMatCollection" UniqueName="YieldatMatCollection"
                                                                                    Visible="true">
                                                                                    <ItemStyle HorizontalAlign="left" VerticalAlign="Top" Width="" Wrap="false" />
                                                                                </telerik:GridBoundColumn>
