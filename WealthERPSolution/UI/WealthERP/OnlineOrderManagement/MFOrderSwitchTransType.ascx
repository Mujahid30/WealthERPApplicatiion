...
<table width="100%  cellpadding="0" cellspacing="15">
    <tr id="trStepTwoHeading" runat="server">
        ...
        <div style="float:right; width:100%" id="divControlContainer" runat="server">
            <table id="tbpurchase" width="100%">
                ...
                <tr class="spaceUnder">
                 ...
                 <tr class="spaceUnder">
                    ...
                    <td>
                        <asp:DropDownList ID="ddlFolio" CssClass="cmbField" runat="server" AutoPostBack="True" OnSelectedIndexChanged="ddlFolio_OnSelectedIndexChanged">
  ...
  <table width="100%" >
    ...
    <div style="float:right; width:100%" id="divControlContainer2" runat="server">
    <table id="Table1" width="100%">
                ...
                <tr class="spaceUnder">
                    ...
                    <td>
                        <asp:DropDownList ID="ddlSchemeName" runat="server" CssClass="cmbExtraLongField" AutoPostBack="true"
         OnSelectedIndexChanged="ddlSchemeName_OnSelectedIndexChanged">
                        </asp:DropDownList>
                ...
                <tr class="spaceUnder" id="tr5" visible="true" runat="server">
                    <td>
                    </td>
                    ...
                    <td align="left" style="vertical-align: top;" colspan="3">
                        <table width="75%" class="SchemeInfoTable">
                            ...
                            <tr>
                                ...
                                <td align="left" style="vertical-align: top;">
                                    <asp:Label ID="lblSqnAmnt" runat="server" Text="Subsequent Amount:</br>(In Multiples Of)" CssClass="FieldName"></asp:Label>
                                </td>
                                <td>
                ...
                <tr class="spaceUnder">
                    ...
                    <td>
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator9" runat="server" ErrorMessage="Please Select a Amount"
                            CssClass="rfvPCG" ControlToValidate="txtSwitchAmnt" ValidationGroup="btnSubmit" Display="Dynamic"></asp:RequiredFieldValidator>
                        <br />
                       ...
                       <asp:CompareValidator ID="cvAmnt" ControlToValidate="txtSwitchAmnt" runat="server" Operator="LessThanEqual" CssClass="rfvPCG"
                             ValidationGroup="btnSubmit"  ControlToCompare="txtAmtVale"  ErrorMessage="Please Enter Value Than"></asp:CompareValidator>
