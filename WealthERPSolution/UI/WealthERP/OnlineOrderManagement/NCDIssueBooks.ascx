                            ...
                            <tr>
                                <td>
                                    <telerik:RadGrid ID="gvBBList" runat="server" GridLines="None" AutoGenerateColumns="False"
                                        ...
                                        <MasterTableView DataKeyNames="Scrip" Width="120%" AllowMultiColumnSorting="True"
                                            AutoGenerateColumns="false" CommandItemDisplay="None">
                                            <Columns>
                                                <telerik:GridTemplateColumn ItemStyle-Width="80Px" AllowFiltering="false" Visible="true"
                                                    HeaderText="Action">
                                                    <ItemTemplate>
                                ...
                                <ItemStyle Width="" HorizontalAlign="left" Wrap="false" VerticalAlign="Top" />
                                                ...
                                                <telerik:GridBoundColumn DataField="BBInterestPaymentFreq" AllowFiltering="false"
                                                    HeaderText="Interest Payment Freq" UniqueName="BBInterestPaymentFreq">
                                                    <ItemStyle Width="" HorizontalAlign="left" Wrap="false" VerticalAlign="Top" />
                                                </telerik:GridBoundColumn>
