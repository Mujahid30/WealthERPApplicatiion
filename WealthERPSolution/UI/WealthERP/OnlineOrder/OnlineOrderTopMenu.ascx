...
<table cellpadding="0" cellspacing="0" style="top: auto; vertical-align: top">
    ...
    <tr id="trMFOrderMenuBooksTab" runat="server" visible="false">
        <td>
            <telerik:RadTabStrip ID="RTSMFOrderMenuBooks" runat="server" Skin="Telerik" MultiPageID="RMPMFOrderMenuBooks"
    ...
    <tr id="trMFOrderMenuHoldingsTab" runat="server" visible="false">
        <td>
            <telerik:RadTabStrip ID="RTSMFOrderMenuHoldings" runat="server" Skin="Telerik" MultiPageID="RMPMFOrderMenuHoldings"
