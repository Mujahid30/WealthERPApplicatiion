...
<table width="100%">
    ...
    <tr>
        <td align="right">
            <asp:Label ID="lblextract" runat="server" CssClass="FieldName" Text="EXtract:"></asp:Label>
        </td>
        <td>
            <telerik:RadDatePicker ID="dateextrat" CssClass="txtField" runat="server" Culture="English (United States)"
