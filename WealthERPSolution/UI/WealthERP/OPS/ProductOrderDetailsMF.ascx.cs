...
namespace WealthERP.OPS
{
    public partial class ProductOrderDetailsMF : System.Web.UI.UserControl
    {
        ...
        DataTable Agentname;
        int hdnCustomerId;
        public delegate void IndexChangedEventHandler(String selectedIndex);
        ...
        //  //        else  
        //  //       {
        //        //sai hdnType.Value = ddltransType.SelectedValue.ToString();
        ...
        //                BindScheme(0);
        //                //BindFolioNumber(0);
        //                //sai  trFrequency.Visible = false;
        //                //sai  trSIPStartDate.Visible = false;
        //            }
        ...
        //                BindScheme(0);
        //                //BindFolioNumber(0);
        //                //sai  trFrequency.Visible = true;
        //                //sai  trSIPStartDate.Visible = true;
        //            }
        //            else
        //            {
        //                BindAMC(1);
        ...
        //            {
        //                //BindSchemeSwitch();
        //                //dbt trScheme.Visible = true;
        //                //sai  trFrequencySTP.Visible = false;
        //                //dbt trSTPStart.Visible = false;
        //            }
        //            else if (ddltransType.SelectedValue == "STB")
        //            {
        //                //dbt trScheme.Visible = true;
        //                //sai  trFrequencySTP.Visible = true;
        //                //dbt trSTPStart.Visible = true;
        //            }
        //            else if (ddltransType.SelectedValue == "SWP")
        //            {
        //                //dbt trScheme.Visible = false;
        //                //sai  trFrequencySTP.Visible = true;
        //                //dbt trSTPStart.Visible = true;
        //            }
        //            else
        ...
        protected void ShowTransactionType(int type)
        {
            if (type == 0)
            {
               ...
               //sai //sai  trFrequency.Visible = false;
               //sai //sai  trSIPStartDate.Visible = false;
                //sai trAddress6.Visible = false;
                //sai
                //trSection2.Visible = false;

                //trGetAmount.Visible = false;
                //trRedeemed.Visible = false;
               //sai //dbt trScheme.Visible = false;
                ////sai  trFrequencySTP.Visible = false;
                ////dbt trSTPStart.Visible = false;

                //sai trSection3.Visible = false;

                //sai  trAddress1.Visible = false;
                //sai  trOldLine1.Visible = false;
                //sai
  ...
  trBtnSubmit.Visible = true;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                hdnCustomerId = int.Parse(Session["test"].ToString());
                txtCustomerId.Value = hdnCustomerId.ToString();
            }
        ...
        {
            Session["MFTranstype"] = ddltransType.SelectedValue;
            System.Collections.Hashtable ht = new System.Collections.Hashtable();          

            ht.Add("TransactionCode", ddltransType.SelectedValue);
            ht.Add("ApplicationReceivedDate", txtReceivedDate.SelectedDate);
            ht.Add("ApplicationNumber",  txtApplicationNumber.Text);
            ht.Add("Amccode",ddlAMCList.SelectedValue);
            ht.Add("category", ddlCategory.SelectedValue);
            ht.Add("SchemePlanCode", ddlAmcSchemeList.SelectedValue);
            ht.Add("portfolioId", ddlPortfolio.SelectedValue);
            ht.Add("FolioNumber", ddlFolioNumber.SelectedValue);            
              ht.Add("OrderDate", txtOrderDate.SelectedDate);
              ht.Add("OrderNumber", lblGetOrderNo.Text);
              ht.Add("IsImmediate", rbtnImmediate.Checked);
              ht.Add("FutureExecutionDate", txtFutureDate.SelectedDate);
              ht.Add("FutureTriggerCondition", txtFutureTrigger.Text);
        ...
        //            lblGetOrderNo.Text = mforderVo.OrderNumber.ToString();
        //            //sai hdnType.Value = mforderVo.TransactionCode;
        ...
        private void BindAMC(int Aflag)
        {
            ...
            try
            {
                if (Aflag == 0)
                    ...
                    dsProductAmc = operationBo.GetAMCForOrderEntry(Aflag,  hdnCustomerId  );
        ...
        protected void ddltransType_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (IndexChanged != null)
                IndexChanged(ddltransType.SelectedValue);
         ...
         spnAMC.Visible = true; spnScheme.Visible = true;
         BindCategory();
       ////sai     CompareValidator1.Visible = true; CompareValidator2.Visible = true;
             ...
             if (ddltransType.SelectedValue == "BUY" || ddltransType.SelectedValue == "ABY" || ddltransType.SelectedValue == "SIP")
               {
                 ...
                 else if (ddltransType.SelectedValue == "SIP")
                 {
                     ...
                     //BindFolioNumber(0);
                     //sai  trFrequency.Visible = true;
                     //sai  //sai  trSIPStartDate.Visible = true;
                 }
                 else
                 {
                     BindAMC(1);
       ...
       //     //btnViewInDOCNew.Visible = true;
        ...
        protected void ddlAmcSchemeList_SelectedIndexChanged(object sender, EventArgs e)
        {
          //  sai
            ...
            {
                schemePlanCode = int.Parse(ddlAmcSchemeList.SelectedValue);
                hdnSchemeCode.Value =  ddlAmcSchemeList.SelectedValue ;
        ...
        //        "&AccoutId=" + hdnAccountId.Value + "&SchemeCode=" + hdnSchemeName.Value + "&Type=" + //sai hdnType.Value + "&Portfolio=" + portfolioId +
