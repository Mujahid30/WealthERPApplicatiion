<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="RejectedSystematicTransactionStaging.ascx.cs" Inherits="WealthERP.SuperAdmin.RejectedSystematicTransactionStaging" %>
