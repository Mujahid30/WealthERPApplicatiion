...
<asp:UpdatePanel ID="updatePanel1" runat="server"><ContentTemplate>
    ...
    <tr>
    <td class="HeaderCell">
        <asp:Label ID="lblPriceMonitoring" CssClass="HeaderTextBig" runat="server" Text="Price Monitoring"></asp:Label>
    </td>
    </tr>
    <tr>
    <td>
    ...
    <td>
<asp:Button ID="btnShowBetweendates" runat="server" Text="Go" 
    ...
    ErrorMessage="Please Enter Valid From Date" ValidationGroup="btnShowBetweendates"
        />
    </td>
    <td></td>
        <td style="font-size:x-small">
    ...
    Type="Date"
    Operator="DataTypeCheck"
    ErrorMessage="Please Enter Valid To Date" ValidationGroup="btnShowBetweendates"/>
    ...
    <td style="font-size:x-small">
    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtFromDate" ErrorMessage="please enter from date" ValidationGroup="btnShowBetweendates"></asp:RequiredFieldValidator>
    </td>
    <td></td>
    <td style="font-size:x-small">
    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtToDate" ErrorMessage="please enter to date" ValidationGroup="btnShowBetweendates"></asp:RequiredFieldValidator>
    </td>
    </tr>
    </table>
  <%--  </ContentTemplate></asp:UpdatePanel>--%>
    ...
    <tr id="trNoRecords" runat="server">
        <td>
            <asp:Label ID="lblMsg" class="Error" runat="server" Visible="false"></asp:Label>
        </td>
    </tr>
    </table>
        <table>
    ...
    <tr id="trPagger" runat="server">
        ...
        <Columns>
        <asp:TemplateField HeaderText="Select" ItemStyle-Wrap="false" HeaderStyle-Wrap="false"> 
                     <ItemTemplate>
...
<%--</ContentTemplate></asp:UpdatePanel>--%>
    ...
    <td>
    <asp:Button ID="btnEdit" runat="server" Text="Edit" CssClass="PCGButton" onclick="btnEdit_Click" 
            />
    </td>
    <td>
   ...
   <td><asp:Label class="FieldName" ID="lblMessage" runat="server"></asp:Label></td>
    ...
    <td></td>
    <td>
    <asp:Label runat="server" Text="Note: Gold price as per 10 gms" class="FieldName"></asp:Label>
    </td>
    </tr>
    </table>
    </asp:Panel>
