...
{
    public partial class AdviserUploads : System.Web.UI.UserControl
    {
                    ...
                    if (XmlCreated == true && rejectUpload_Flag == false)
                    {
                        ...
                        //MF CAMS Transaction Upload
                            ...
                            //MF standard Transaction Upload gobinda
                                ...
                                //    bool werpMFProCreateCustomerResult = werpMFUploadsBo.WerpMFInsertCustomerDetails(adviserId, UploadProcessId, rmId, out countCustCreated, out countFolioCreated);
