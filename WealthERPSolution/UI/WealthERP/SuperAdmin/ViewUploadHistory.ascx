<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ViewUploadHistory.ascx.cs" Inherits="WealthERP.SuperAdmin.ViewUploadHistory" %>
    ...
    <tr>
        <td>
            <asp:GridView ID="gvProcessLog" runat="server" AutoGenerateColumns="False" CellPadding="4"
                CssClass="GridViewStyle" DataKeyNames="ADUL_ProcessId,WUXFT_XMLFileTypeId,XUET_ExtractTypeCode,A_AdviserId,AR_RMId" AllowSorting="true"
