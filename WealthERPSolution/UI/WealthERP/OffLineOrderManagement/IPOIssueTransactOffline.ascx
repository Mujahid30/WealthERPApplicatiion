...
<asp:Panel ID="pnl_OrderSection" runat="server" class="Landscape" Width="100%" Height="80%"
    ...
    <table width="100%">
        ...
        <tr id="trCust" runat="server" visible="false">
            ...
            <td class="rightField" style="width: 20%">
                <asp:TextBox ID="txtCustomerName" onkeydown="return (event.keyCode!=13);" runat="server" CssClass="txtField" AutoComplete="Off"
        ...
        <tr>
            ...
            <td class="rightField" style="width: 20%">
                <asp:TextBox ID="txtAssociateSearch" onkeydown="return (event.keyCode!=13);" runat="server" CssClass="txtField" AutoComplete="Off"
        ...
        <tr>
            ...
            <td class="rightField" style="width: 20%">
                <asp:TextBox ID="txtApplicationNo" onkeydown="return (event.keyCode!=13);" runat="server"
                    CssClass="txtField" MaxLength="6" OnKeypress="javascript:return isNumberKey(event);"></asp:TextBox>
    ...
    <asp:Label ID="lblDPId" runat="server" Text="DP ID: "
     ...
     <td class="rightField" style="width: 20%">
        ...
        <tr id="trASBA" runat="server" visible="false">
            ...
            <td class="rightField">
                <asp:TextBox ID="txtASBANO" onkeydown="return (event.keyCode!=13);" runat="server" CssClass="txtField"></asp:TextBox>
...
<asp:Panel ID="Panel1" runat="server" class="Landscape" Width="100%" Height="80%"
    ...
    <table width="100%" cellspacing="10">
        ...
        <tr>
            ...
            <td class="rightField" style="width: 20%">
                <asp:TextBox ID="txtDematid" onkeydown="return (event.keyCode!=13);" runat="server" CssClass="txtField"></asp:TextBox>
