                                            ...
                                            <MasterTableView DataKeyNames="COAD_Id,PAISC_AssetInstrumentSubCategoryCode" AllowMultiColumnSorting="True"
                                                ...
                                                <Columns>
                                                    ...
                                                    <telerik:GridBoundColumn DataField="AIM_AllotmentDate" SortExpression="AIM_AllotmentDate"
                                                        AutoPostBackOnFilter="true" CurrentFilterFunction="Contains" ShowFilterIcon="false"
                                                        AllowFiltering="true" HeaderStyle-Width="160px" HeaderText="AllotmentDate" UniqueName="AIM_AllotmentDate">
                                                        <ItemStyle Width="" HorizontalAlign="left" Wrap="false" VerticalAlign="Top" />
                                                    </telerik:GridBoundColumn>
                                                    <telerik:GridBoundColumn DataField="COAD_Quantity" SortExpression="COAD_Quantity"
                                                        AutoPostBackOnFilter="true" CurrentFilterFunction="Contains" ShowFilterIcon="false"
                                                        AllowFiltering="true" HeaderStyle-Width="160px" HeaderText="Quantity" UniqueName="COAD_Quantity">
                                                        <ItemStyle Width="" HorizontalAlign="left" Wrap="false" VerticalAlign="Top" />
                                                    </telerik:GridBoundColumn>
                                                    <telerik:GridBoundColumn DataField="COAD_Price" SortExpression="COAD_Price" AutoPostBackOnFilter="true"
                                                        CurrentFilterFunction="Contains" ShowFilterIcon="false" AllowFiltering="true"
                                                        HeaderStyle-Width="160px" HeaderText="Price" UniqueName="COAD_Price" DataFormatString="{0:N2}"
                                                        Aggregate="Sum">
                                                        <ItemStyle Width="" HorizontalAlign="left" Wrap="false" VerticalAlign="Top" />
                                                    </telerik:GridBoundColumn>
                                                    <telerik:GridBoundColumn DataField="COAD_InterestAmount" SortExpression="COAD_InterestAmount"
                                                        AutoPostBackOnFilter="true" CurrentFilterFunction="Contains" ShowFilterIcon="false"
                                                        AllowFiltering="true" HeaderStyle-Width="160px" HeaderText="Interest Rate(%)"
                                                        UniqueName="COAD_InterestAmount">
                                                        <ItemStyle Width="" HorizontalAlign="left" Wrap="false" VerticalAlign="Top" />
                                                    </telerik:GridBoundColumn>
                                                    <telerik:GridBoundColumn DataField="WCMV_Name" SortExpression="WCMV_Name" AutoPostBackOnFilter="true"
                                                        CurrentFilterFunction="Contains" ShowFilterIcon="false" AllowFiltering="true"
                                                        HeaderStyle-Width="160px" HeaderText="Interest Frequency" UniqueName="WCMV_Name">
                                                        <ItemStyle Width="" HorizontalAlign="left" Wrap="false" VerticalAlign="Top" />
                                                    </telerik:GridBoundColumn>
                                                    ...
                                                    <telerik:GridBoundColumn DataField="COAD_MaturityDate" SortExpression="COAD_MaturityDate"
                                                        AutoPostBackOnFilter="true" CurrentFilterFunction="Contains" ShowFilterIcon="false"
                                                        AllowFiltering="true" HeaderStyle-Width="160px" HeaderText="Maturity Date" UniqueName="COAD_MaturityDate">
                                                        <ItemStyle Width="" HorizontalAlign="left" Wrap="false" VerticalAlign="Top" />
                                                    </telerik:GridBoundColumn>
                                                    <telerik:GridBoundColumn DataField="currentValue" SortExpression="currentValue" AutoPostBackOnFilter="true"
                                                        CurrentFilterFunction="Contains" ShowFilterIcon="false" AllowFiltering="true"
                                                        HeaderStyle-Width="160px" Aggregate="Sum" DataFormatString="{0:N2}" HeaderText="Current Value"
                                                        UniqueName="currentValue">
                                                        <ItemStyle Width="" HorizontalAlign="left" Wrap="false" VerticalAlign="Top" />
                                                    </telerik:GridBoundColumn>
                                                    <telerik:GridBoundColumn DataField="COAD_MaturityAmount" SortExpression="COAD_MaturityAmount"
                                                        AutoPostBackOnFilter="true" CurrentFilterFunction="Contains" ShowFilterIcon="false"
                                                        AllowFiltering="true" HeaderStyle-Width="160px" Aggregate="Sum" DataFormatString="{0:N2}"
                                                        HeaderText="Maturity Amount" UniqueName="COAD_MaturityAmount">
                                                        <ItemStyle Width="" HorizontalAlign="left" Wrap="false" VerticalAlign="Top" />
                                                    </telerik:GridBoundColumn>
                                                    <telerik:GridBoundColumn DataField="COAD_OrderDate" SortExpression="COAD_OrderDate"
                                                        AutoPostBackOnFilter="true" CurrentFilterFunction="Contains" ShowFilterIcon="false"
                                                        AllowFiltering="true" HeaderStyle-Width="160px" HeaderText="Order Date" UniqueName="COAD_OrderDate"
                                                        Visible="false">
                                                        <ItemStyle Width="" HorizontalAlign="left" Wrap="false" VerticalAlign="Top" />
                                                    </telerik:GridBoundColumn>
                                                    <telerik:GridBoundColumn HeaderText="Nominee Name" DataField="JntName" UniqueName="NName"
