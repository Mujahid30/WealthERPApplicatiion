        ...
        <td>
            <div class="divPageHeading">
                <table cellspacing="0" cellpadding="2" width="100%">
                    <tr>
                        <td align="left">
<%--                           <asp:Label ID="Label3" runat="server" CssClass="HeaderTextBig" Text="FD Order Book"></asp:Label>
--%>                      
                <asp:Label ID="lblProductTypess"  runat="server" CssClass="HeaderTextBig"></asp:Label>
                       </td>
                         ...
                         <telerik:RadGrid ID="gv54FDOrderBook" runat="server" GridLines="None" AutoGenerateColumns="False"
                                ...
                                <MasterTableView DataKeyNames="CO_OrderId,AIM_IssueId,C_CustomerId,AAC_AgentCode,AssociatesName,Orderstep,CO_IsAuthenticated,AIM_CloseDate"
                                    ...
                                    <Columns>
                                        ...
                                        <telerik:GridBoundColumn DataField="CO_Remarks" SortExpression="CO_Remarks"
                                            AutoPostBackOnFilter="true" CurrentFilterFunction="Contains" ShowFilterIcon="false"
                                            AllowFiltering="true" HeaderStyle-Width="160px" HeaderText="Remarks" UniqueName="CO_Remarks">
                                            <ItemStyle Width="" HorizontalAlign="left" Wrap="false" VerticalAlign="Top" />
                                        </telerik:GridBoundColumn>
