<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="OfflineCustomersIPOOrderBook.ascx.cs" Inherits="WealthERP.OffLineOrderManagement.OfflineCustomersIPOOrderBook" %>
