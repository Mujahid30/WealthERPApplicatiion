<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="AdviserLoginTrack.ascx.cs" Inherits="WealthERP.Advisor.AdviserLoginTrack" %>
...
<table width="100%" class="TableBackground">
        ...
        <telerik:RadDatePicker ID="txtFrom" CssClass="txtField" runat="server" Culture="English (United States)"
            ...
            <tr>
            <td>
             <telerik:RadGrid ID="gvLoginTrack" AllowSorting="true" runat="server" AllowAutomaticInserts="false" EnableLoadOnDemand="true"
                        AllowFilteringByColumn="true" AllowPaging="True" AutoGenerateColumns="False" EnableViewState="true" 
                        EnableEmbeddedSkins="false" GridLines="Both" PageSize="10" ShowFooter="true"  PagerStyle-AlwaysVisible="true" 
