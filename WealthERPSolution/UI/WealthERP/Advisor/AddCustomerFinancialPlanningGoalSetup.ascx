                        ...
                        <asp:GridView ID="gvGoalOutPut" runat="server" AllowSorting="True" 
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Goal Type">
                                    <ItemTemplate>
                                        <asp:LinkButton ID="lnkGoalType" runat="server" CssClass="GridViewCmbField" 
                                            OnClick="lnkGoalType_Click" Text='<%# Eval("GoalName") %>'>
                                        </asp:LinkButton>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Name of Associate Customer">
                                    <ItemTemplate>
                                        <asp:Label ID="lblAssociateName" runat="server" CssClass="GridViewCmbField" 
                                            Text='<%#Eval("ChildName") %>'>
                                        </asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                ...
                                <asp:TemplateField HeaderText="Amount To be Saved Per Month(Rs.)">
                                    ...
                                    <FooterTemplate>
                                        <asp:Label ID="lblTotal" runat="server" CssClass="Field" Font-Bold="true" 
                                ...
                                <asp:TemplateField HeaderText="Calculated On">
                                    <ItemTemplate>
                                        <asp:Label ID="lblGoalDate" runat="server" CssClass="GridViewCmbField" 
                                            Text='<%#Eval("GoalPrifileDate", "{0:M-dd-yyyy}")  %>'>
                                        </asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Required In Year">
                                    <ItemTemplate>
                                        <asp:Label ID="lblGoalYear" runat="server" CssClass="GridViewCmbField" 
                                            Text='<%#Eval("GoalYear") %>'>
                                        </asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="IsActive">
                                    <ItemTemplate>
                                        <asp:Label ID="lblIsActive" runat="server" CssClass="GridViewCmbField" 
                                            Text='<%#Eval("IsActive") %>'>
                                        </asp:Label>
                                    </ItemTemplate>
                                    <HeaderTemplate>
                                ...
                                <asp:TemplateField HeaderText="Approved by customer On">
                                    <ItemTemplate>
                                        <asp:Label ID="lblAporoveOn" runat="server" CssClass="GridViewCmbField" 
                    ...
                    <td>
                        <asp:GridView ID="gvRetirement" runat="server" AllowSorting="True" 
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Goal Type">
                                    <ItemTemplate>
                                        <asp:LinkButton ID="lnkRTGoalType" runat="server" CssClass="GridViewCmbField" 
                                            OnClick="lnkRTGoalType_Click" Text='<%# Eval("XG_GoalName") %>'>
                                        </asp:LinkButton>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Retirement Year">
                                    <ItemTemplate>
                                        <asp:Label ID="lblGoalYear" runat="server" CssClass="GridViewCmbField" 
