...
<%--<div class="exampleWrapper">--%>
    ...
    <telerik:RadMultiPage ID="SetupEmailSMS" EnableViewState="false" runat="server" SelectedIndex="0" Width="100%">
                                ...
                                <td>
                                    <table width="100%">
                                        <tr>
                                            ...
                                            <td class="RightField">
                                                <asp:TextBox ID="txtGridPageSize" runat="server" CssClass="txtField" Width="260px"></asp:TextBox>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td colspan="3">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:Button ID="BtnSubmitpage" runat="server" 
                                                    Text="Submit" CssClass="PCGButton" OnClick="btnSubmitPageSize_Click" />
                                            </td>
                                            <td class="tdEmpty">
                                            </td>
                                        </tr>
