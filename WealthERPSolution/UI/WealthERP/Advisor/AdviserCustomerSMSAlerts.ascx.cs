...
namespace WealthERP.Advisor
{
    public partial class AdviserCustomerSMSAlerts : System.Web.UI.UserControl
    {
        ...
        protected void gvAlertNotification_OnNeedDataSource(object sender, Telerik.Web.UI.GridNeedDataSourceEventArgs e)
        {
            //DataTable dtCustomerSIPAlert = new DataTable();
            //dtCustomerSIPAlert = (DataTable)Cache["CustomerSIPAlert" + advisorVo.advisorId];
            //if (dtCustomerSIPAlert != null)
            //{
            //    gvAlertNotification.DataSource = dtCustomerSIPAlert;
            //}
        }
