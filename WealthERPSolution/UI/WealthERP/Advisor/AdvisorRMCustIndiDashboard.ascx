...
<asp:Panel ID="tbl" runat="server" class="Landscape" Width="100%" ScrollBars="Horizontal">
    <table width="100%" cellspacing="0" cellpadding="0">
        ...
        <tr>
            ...
            <td width="50%" valign="top">
                <asp:Label runat="server" CssClass="FieldName" Text="You have not Added any Asset Details.."
                ...
                <asp:GridView ID="gvAssetAggrCurrentValue" runat="server" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="Current Value" HeaderText="Current Value" DataFormatString="{0:n2}"
        ...
        <tr>
            <td width="50%" valign="top">
                ...
                <asp:GridView ID="gvLifeInsurance" runat="server" AllowSorting="True" AutoGenerateColumns="False"
                    CellPadding="4" CssClass="GridViewStyle" DataKeyNames="InsuranceNPId" EnableViewState="false"
                    Width="97%">
                    <%--<FooterStyle HorizontalAlign="Center" CssClass="FooterStyle"/>--%>
                    <RowStyle CssClass="RowStyle" />
                    <SelectedRowStyle CssClass="SelectedRowStyle" />
            ...
            <td width="50%" valign="top">
                ...
                <asp:GridView ID="gvGeneralInsurance" runat="server" AllowSorting="True" AutoGenerateColumns="False"
                    CellPadding="4" CssClass="GridViewStyle" DataKeyNames="GenInsuranceNPId" EnableViewState="false"
                    Width="100%">
                    <RowStyle CssClass="RowStyle" />
                    <SelectedRowStyle CssClass="SelectedRowStyle" />
                    <PagerStyle CssClass="PagerStyle" HorizontalAlign="Center" />
                    ...
                    <Columns>
                        <asp:TemplateField HeaderText="Policy Issuer">
                            <ItemTemplate>
                                <asp:LinkButton ID="lnkGeneralInsurancePolicy" runat="server" CssClass="GridViewCmbField"
                                    OnClick="lnkGeneralInsurancePolicy_Click" Text='<%# Eval("PolicyIssuer") %>'>
                                </asp:LinkButton>
                            </ItemTemplate>
                        </asp:TemplateField>
