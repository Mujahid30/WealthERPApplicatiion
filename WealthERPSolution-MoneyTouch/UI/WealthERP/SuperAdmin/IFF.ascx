            ...
            <div id="print" runat="server">
                <asp:GridView ID="gvAdvisorList" runat="server" AllowSorting="True" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="IFFName" HeaderText="IFF" SortExpression="IFFName" ItemStyle-HorizontalAlign="Left" ItemStyle-Wrap="false" />
                        ...
                        <asp:TemplateField ItemStyle-Wrap="false" ItemStyle-HorizontalAlign="Center">
                            ...
                            <ItemTemplate>
                                <asp:Label ID="lblCategory" runat="server" Text='<%# Eval("Category").ToString() %>' ItemStyle-HorizontalAlign="Left"></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                        ...
                        <asp:BoundField DataField="IFFEmailId" HeaderText="Email" ItemStyle-HorizontalAlign="Left"/>
                         <asp:BoundField HeaderText="Is Active" 
                            DataField="imgIFFIsActive" ItemStyle-HorizontalAlign="Left">
                        </asp:BoundField>
                        <asp:BoundField HeaderText="MF Subs" 
                            DataField="imgIFFMutualfund" ItemStyle-HorizontalAlign="Left">
                        </asp:BoundField>
                        <asp:BoundField HeaderText="EQ Subs" 
                            DataField="imgIFFEquity" ItemStyle-HorizontalAlign="Left">
                        </asp:BoundField>
                        <asp:BoundField HeaderText="LI Subs" 
                            DataField="imgIFFInsurance" ItemStyle-HorizontalAlign="Left">
                        </asp:BoundField>
                        <asp:BoundField HeaderText="Loan Subs" 
                            DataField="imgIFFLiabilities" ItemStyle-HorizontalAlign="Left">
                        </asp:BoundField>
                        <asp:BoundField HeaderText="PMS Subs" 
                            DataField="imgIFFPMS" ItemStyle-HorizontalAlign="Left">
                        </asp:BoundField>
                        <asp:BoundField HeaderText="Fixed Inc. Subs" 
                            DataField="imgIFFFixedIncome" ItemStyle-HorizontalAlign="Left">
                        </asp:BoundField>
                        <asp:BoundField HeaderText="Postal Subs" 
                            DataField="imgIFFPostalSavings" ItemStyle-HorizontalAlign="Left">
                        </asp:BoundField>
                        <asp:BoundField HeaderText="Commodities Subs" 
                            DataField="imgIFFComodities" ItemStyle-HorizontalAlign="Left">
                        </asp:BoundField>                        
                        <asp:BoundField HeaderText="Real Est., Subs" 
                            DataField="imgIFFRealEstate" ItemStyle-HorizontalAlign="Center">
                        </asp:BoundField>   
                    </Columns>
                </asp:GridView>
            </div>
