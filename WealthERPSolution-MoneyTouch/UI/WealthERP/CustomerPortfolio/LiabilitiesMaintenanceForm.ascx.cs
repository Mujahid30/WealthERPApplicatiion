    ...
    public partial class LiabilitiesMaintenanceForm : System.Web.UI.UserControl
    {
        ...
        protected void BindDropDowns()
        {
            try
            {
                ...
                DataTable dtRepayment = XMLBo.GetRepaymentType(path);
                ddlRepaymentType.DataSource = dtRepayment;
                ddlRepaymentType.DataTextField = dtRepayment.Columns["XRT_RepaymentType"].ToString();
                ddlRepaymentType.DataValueField = dtRepayment.Columns["XRT_RepaymentTypeCode"].ToString();
                ddlRepaymentType.DataBind();
                ddlRepaymentType.Items.Insert(0, new ListItem("Select the Repayment Type", "Select the Repayment Type"));
        ...
        protected void ViewLiability()
        {
            ...
            try
            {
                ...
                if (liabilityVo.IsFloatingRateInterest == 1)
                {
                    ...
                    rbtnFloatYes.Enabled = false;
                    rbtnFloatNo.Enabled = false;
                }
                else
                {
                    rbtnFloatNo.Checked = true;
                    rbtnFloatYes.Enabled = false;
                    rbtnFloatNo.Enabled = false;
                }
                ...
                {
                    //ddlGuarantor.Items.Insert(0, new ListItem("Select a Lender", "Select a Lender"));
                    ddlLender.Enabled = false;
                }
                ...
                if (dtRepayment != null)
                {
                    ...
                    ddlRepaymentType.DataValueField = dtRepayment.Columns["XRT_RepaymentTypeCode"].ToString();
                    ddlRepaymentType.DataBind();
                    ddlRepaymentType.SelectedValue = liabilityVo.RepaymentTypeCode.ToString();
                    ddlRepaymentType.Enabled = false;
                }
                else
                {
                    //ddlGuarantor.Items.Insert(0, new ListItem("Select Repayment Type", "Select Repayment Type"));
                    ddlRepaymentType.Enabled = false;
                }
        ...
        protected void EditLiability()
        {
            ...
            {
                rbtnFloatYes.Checked = true;
                rbtnFloatYes.Enabled = true;
                rbtnFloatNo.Enabled = true;
            }
            else
            {
                rbtnFloatNo.Checked = true;
            ...
            if (dt != null)
            {
                ...
                ddlLoanType.DataValueField = dt.Columns["XLT_LoanTypeCode"].ToString();
                ddlLoanType.DataBind();
                ddlLoanType.SelectedValue = liabilitiesVo.LoanTypeCode.ToString();
            }
            ...
            if (dtLender != null)
            {
                ...
                ddlLender.DataValueField = dtLender.Columns["XLP_LoanPartnerCode"].ToString();
                ddlLender.DataBind();
                ddlLender.SelectedValue = liabilitiesVo.LoanPartnerCode.ToString();
            }
            ...
            if (dtRepayment != null)
            {
                ...
                ddlRepaymentType.DataValueField = dtRepayment.Columns["XRT_RepaymentTypeCode"].ToString();
                ddlRepaymentType.DataBind();
                ddlRepaymentType.SelectedValue = liabilitiesVo.RepaymentTypeCode.ToString();
            }
            ...
            if (dtFrequency != null)
            {
                ...
                ddlEMIFrequency.DataValueField = dtFrequency.Columns["FrequencyCode"].ToString();
                ddlEMIFrequency.DataBind();
                ddlEMIFrequency.SelectedValue = liabilitiesVo.FrequencyCodeEMI.ToString();
            }
        ...
        protected void btnUpdate_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (gvValidationResult == 1)
                {
                    ...
                    newLiabilitiesVo.CreatedBy = userVo.UserId;
                    ...
                    {
                        newLiabilitiesVo.IsFloatingRateInterest = 0;
                    }
