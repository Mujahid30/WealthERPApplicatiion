...
<table class="TableBackground" style="width: 100%;">
        ...
        <td class="rightField">
            <asp:DropDownList ID="ddlUploadType" runat="server" OnSelectedIndexChanged="ddlUploadType_SelectedIndexChanged"
             ...
             <asp:RequiredFieldValidator ID="ddlUploadType_RequiredFieldValidator" ControlToValidate="ddlUploadType"
                ValidationGroup="btn_Upload" ErrorMessage="Please select an Extract type" InitialValue="0" Display="Dynamic"
    ...
    <tr id="trListBranch" runat="server" visible="false">
        ...
        <td class="rightField">
            ...
            <asp:CompareValidator ID="ddlListBranch_CompareValidator" runat="server" ControlToValidate="ddlListBranch"
                ErrorMessage="Please select a Branch" Operator="NotEqual" ValueToCompare="Select a Branch" Display="Dynamic"
                CssClass="cvPCG">
    ...
    <tr>
        ...
        <td class="rightField">
            ...
            <asp:CompareValidator ID="ddlListCompany_CompareValidator" runat="server" ControlToValidate="ddlListCompany"
                ErrorMessage="Please select an External Source" Operator="NotEqual" ValueToCompare="Select Source Type" Display="Dynamic"
                CssClass="cvPCG" ValidationGroup="btn_Upload">
            </asp:CompareValidator>
            <asp:RequiredFieldValidator ID="ddlListCompany_RequiredFieldValidator" ControlToValidate="ddlListCompany"
                ValidationGroup="btn_Upload" ErrorMessage="Please select an External Source" Display="Dynamic"
                runat="server" CssClass="rfvPCG">
            </asp:RequiredFieldValidator>
    ...
    <tr>
        <td class="SubmitCell" colspan="4">
            <asp:Button ID="btn_Upload" runat="server" Text="Upload" OnClick="btn_Upload_Click" ValidationGroup="btn_Upload"
                CssClass="PCGButton" onmouseover="javascript:ChangeButtonCss('hover', 'ctrl_CustomerUpload_btn_Upload','S');"
    ...
    <tr>
    <td>
    <asp:Label ID="lblInputError" runat="server" Text="Please rectify the following errors in the source file and Upload again" CssClass="Error"></asp:Label>
    </td>
        
    </tr>
    <tr>
    <td>
    <asp:GridView ID="gvInputError" runat="server" CssClass="GridViewStyle" ShowFooter="true" AllowPaging="true"
    OnPageIndexChanging="gvInputError_PageIndexChanging">
